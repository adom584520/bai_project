...
<body class="easyui-layout" style="visibility: hidden">
		...
		<form id="cpsource"
			...
			<table width="98%" cellspacing="1" cellpadding="3" class="tblMain"
				...
				<tr>
					...
					<td class="tdContent" colspan="3"><input type="text" id="code" name="code"
						class="input text easyui-numberbox"  style="" data-options="validType:'text[1,10]',required:true" /></td>
				</tr>
				<tr>
					<td style="text-align: right; width: 15%" class="tdCaption"
						align="center">名称</td>
					<td class="tdContent" colspan="3"><input type="text" id="name" name="name"
						class="input text easyui-validatebox-disable" style="width: 80%"
				...
				<tr>
					...
					<input type="text" id="bz" name="bz" style="width: 80%"
						class="input text easyui-validatebox-disable" style=""
						data-options="validType:'text[1,200]'" /></td>
				</tr>
				 <tr>
	...
	<script type="text/javascript">
		...
		$(function() {
			...
			t.domain('load',
							{
								url : '${pageContext.request.contextPath}/integrate/cpsource/load/'
										+ id,
								names : [],
			...
			function save() {
				...
				var url = '${pageContext.request.contextPath}/integrate/cpsource/'
