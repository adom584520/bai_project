        ...
        <script type="text/javascript">
                ...
                if(typeof($.data(t[0], 'datagrid')) == 'undefined') {
                	...
                	t.domain('datagrid', {
                        ...
                        columns: [[
										...
										{field: 'contentPoint', title: '内容看点', width: 60, sortable: true, align: 'center', hidden: false},
										{field: 'type', title: '类型', width: 60, sortable: true, align: 'center', hidden: false,formatter:formatterType},
										...
										{field: 'sequence', title: '排序', width: 40, sortable: true, align: 'center', hidden: false},
        	...
        	var sysBtnno=$.extend($.fn.domain.btnno,{
        		...
        		handler:function(){
        			var nodes=$t.datagrid("getSelections");
        			if(!nodes||nodes.length==0){
        				tob.$.messager.alert("信息","请您选择需要下线的记录","info",null,2000);
        				return;
        			}
        			if(!nodes||nodes.length>1){
        				top.$.messager.alert("信息","只能选择一条记录！","info",null,2000);
        	...
        	var sysBtnreset=$.extend($.fn.domain.reset,{
        		...
        		handler:function(){
        			$.ajax({
                      	url:"${pageContext.request.contextPath}/phonereset/resetslideshow",
                      	type:"GET",
                      	dataType:"JSON",
                      	data:{},
                      	async:false,
