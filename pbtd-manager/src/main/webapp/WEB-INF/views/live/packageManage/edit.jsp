...
<div data-options="region:'center',border:false" style="padding:0px;">
    <form id="vodchannel"  accept-charset="utf-8" style="margin:10px; padding:0; visibility:hidden" method="post" autoTypeset="false" columnSize="2">
			...
			节目包编号
					...
					<td class="tdContent">
				<input id="packageid" name="packageid" <c:if test="${id>0 }"> type="text" disabled="disabled" </c:if>  class="input text easyui-validatebox-disable" style="" data-options="validType:'text[1,127]',required:true" />
					</td>
				</tr>
			</c:if> 
			<tr>
		...
		节目包名
				...
				<td class="tdContent">
		<input type="text" id="packagename"name="packagename" class="input text easyui-validatebox-disable" style="" data-options="validType:'text[1,127]',required:true"  />	
	</td>
			</tr>
			<tr>
				<td style="text-align: right; width: 15%"  class="tdCaption"  align="center">
		...
		节目封面
				...
				<td class="tdContent">
		<input type="text" id="packagecover" name="packagecover" class="input text easyui-validatebox-disable" style="" data-options="validType:'text[1,127]',required:true"  />	
	</td>
			</tr>
			<tr>
				<td style="text-align: right; width: 15%"  class="tdCaption"  align="center">
		节目海报
				...
				<td class="tdContent">
		<input type="text" id="packageposter"name="packageposter" class="input text easyui-validatebox-disable" style="" data-options="validType:'text[1,127]',required:true"  />	
	</td>
			</tr>
			<tr>
				<td style="text-align: right; width: 15%"  class="tdCaption"  align="center">
		节目包状态
				...
				<td class="tdContent">
				<select id="packagestats" name="packagestats"  style="width: 120px;" class="chzn-select">
		...
		节目包排序
				...
				<td class="tdContent">
		<input type="text" id="packageorder"name="packageorder" class="input text easyui-validatebox-disable" style="" data-options="validType:'text[1,127]',required:true"  />	
	</td>
			</tr>
			</table>
    </form>
...
<script type="text/javascript">
	//页面初始化
   	$(function(){
	        ...
	        //加载数据
	        t.domain('load', {
	            url: '${pageContext.request.contextPath}/live/Package/load/' + id,
	            names: [],
	    ...
	    var  url= '${pageContext.request.contextPath}/live/Package/'+($.query.getId()=="0"?'create':'edit/'+id);  
		     t.domain('edit', {
	             title: ' ',
	             url: url,
	             data: data,
