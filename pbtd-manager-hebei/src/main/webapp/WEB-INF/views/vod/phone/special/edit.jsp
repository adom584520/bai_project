	...
	<input type="hidden" id="id" name="id" />
		...
		专题类型
				...
				<select id="type" name="type"  style="width: 120px;" class="chzn-select">
						...
						<option value="10">镇魂街类</option>
						<option value="11">盛世类</option>
						<option value="12">这就是街舞类</option>
					</select>
	</ >
			</tr>
				<tr>
		...
		网页跳转地址
				...
				<td class="tdContent">
				<input type="text" id="web_url"name="web_url" style="" data-options="validType:'text[1,256]',required:true" />
				</td>
			</tr>
			<tr>
				<td style="text-align: right; width: 15%"  class="tdCaption"  align="center">
...
<script type="text/javascript">
	//页面初始化
   	$(function(){
	        ...
	        //加载数据
	        t.domain('load', {
	            url: '${pageContext.request.contextPath}/vod/phone/vodSpecial/load/' + id,
	            names: [],
	    ...
	    var  url= '${pageContext.request.contextPath}/vod/phone/vodSpecial/'+($.query.getId()=="0"?'create':'edit/'+id);  
		     t.domain('edit', {
	             title: ' ',
	             url: url,
	             data: data,
