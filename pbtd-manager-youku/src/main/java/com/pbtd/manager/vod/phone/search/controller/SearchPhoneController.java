...
public class SearchPhoneController {
	...
	public String indexImport(Model model) throws Exception {
		...
		try {
			// 通知activemq
			ActivemqUtils.testTopicProducer(activemqTCP, topicName, "1");
	...
	public String deleteDocumentByQuery() {
		try {
			// 通知activemq
			ActivemqUtils.testTopicProducer(activemqTCP, topicName, "0");
	...
	public String optimizeIndex() {
		try {
			// 通知activemq
			ActivemqUtils.testTopicProducer(activemqTCP, topicName, "2");
	...
	public String titleIndexImport(Model model) throws Exception {
		...
		try {
			// 通知activemq
			ActivemqUtils.testTopicProducer(activemqTCP, topicName, "3");
	...
	public String deleteTitleIndex() {
		try {
			// 通知activemq
			ActivemqUtils.testTopicProducer(activemqTCP, topicName, "4");
	...
	public String titleIndexOptimize() {
		try {
			// 通知activemq
			ActivemqUtils.testTopicProducer(activemqTCP, topicName, "5");
	...
	public void phoneIndexAdd(String ids) {
		...
		try {
			// 通知activemq
			ActivemqUtils.testTopicProducer(activemqTCP, topicNameID, ids);
