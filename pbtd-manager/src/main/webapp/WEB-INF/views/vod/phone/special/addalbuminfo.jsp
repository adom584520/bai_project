    ...
    <body class="easyui-layout" style="visibility:hidden">
      <div data-options="region:'north',border:false,split:true" style="padding:0px; border-bottom:1px solid #99BBE8; height:74px; width:auto;">
            ...
            <span class="property"> <label class="">专辑标识：</label> <input
				type="text" id="seriesCode" name="seriesCode" style="width: 120px;" />
			</span>
			...
			<span class="property"> <label class="">导演：</label> <input
				type="text" id="writerName" name="writerName" style="width: 120px;" />
			</span>
			<span class="property"> <label class="">主演：</label> <input
				type="text" id="actorName" name="actorName" style="width: 120px;" />
			</span>
			...
			<label class="">频道：</label>
					<select  id="channel" name="channel" onchange="choosechannellabel(this.value);" style="width: 120px;">
						<option selected="selected" value="${channelCode}">${channelName}</option>
						<option value="">--请选择--</option>
       ...
       <script type="text/javascript" src="/js/common/jquery-easyui-1.3.1/common.js"></script>
        ...
        function getisStorage(value){
        	 var ckButton='';
        	 if(value=="1"){
		    	 ckButton = "<span style='color: green;'>已入库</span>";
		     }else{
		    	 ckButton = "<span style='color: red;'>未入库</span>";
		     }
        	 return ckButton
        }
	        	...
	        	function choosechannellabel2(value){
	        	 ...
	        	 function show(id){
	         		$(parent).domain("openDialog", { 
	     	        	iconCls: "icon-view", 
	     	        	title: "查看", 
	     	        	src: "${pageContext.request.contextPath}/vod/phone/vodalbuminfo/show/"+id,
	     	        	width: 1060, 
	    	        	height: 550,
	     	        	onClose: function() { 
	     	            }
