...
public interface VodChannelMapper  {
    ...
    Vodchannel loadone();
    Vodchannel loadbychannel(String channelCode);
    /**
     * 插入记录
     */
    ...
    int insertPrimary(@Param("id")Integer id, @Param("channelName")String channelName, @Param("channelCode")Integer channelCode);
    //插入绑定专辑信息
  ...
  //查询绑定信息的最大和最小排序
   ...
   //查询绑定标签 排序
    ...
    int updateSeqByChannelCode(Vodchannel vodchannel);
