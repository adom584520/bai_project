        ...
        <script type="text/javascript"> 
            function getinfo() {
                ...
                if(typeof($.data(t[0], 'datagrid')) == 'undefined') {
                	...
                	t.domain('datagrid', {
                        title: '绑定数据',
                    	url: '${pageContext.request.contextPath}/vod/tv/vodSpecial/albuminfopage',
	                    ...
	                    title:"添加节目",
	               		...
	               		handler: function() {
	               			$(parent).domain("openDialog", { 
	    	     	        	iconCls: "icon-view", 
	    	     	        	title: "添加", 
	    	     	        	src: "${pageContext.request.contextPath}/vod/tv/vodSpecial/addalbuminfo/"+$tagsids,
	    	     	        	width: 1250, 
	    	    	        	height: 650,
	    	     	        	onClose: function() { 
	    	     	        		var ids = top.$.data(top.document.body, "choose.ids");
	    	     	        		$.ajax({
	    	                           	url:"${pageContext.request.contextPath}/vod/tv/vodSpecial/addalbuminfo",
	    	                           	type:"GET",
	    	                           	dataType:"JSON",
	               	    	...
	               	    	$.messager.confirm('确认','确认删除？',function(r){
	               	    		if(r){
			               	        ...
			               	        for (var i = 0; i < nodes.length; i++) {
		   	     	        		...
		   	     	        		$.ajax({
		   	                           	url:"${pageContext.request.contextPath}/vod/tv/vodSpecial/delalbuminfo",
		   	                           	type:"GET",
		   	                           	dataType:"JSON",
