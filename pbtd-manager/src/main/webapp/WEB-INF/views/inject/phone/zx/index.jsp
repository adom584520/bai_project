        ...
        <script type="text/javascript"> 
            function getalbumin() {
                ...
                if(typeof($.data(t[0], 'datagrid')) == 'undefined') {
                	...
                	t.domain('datagrid', {
                        title: 'phone节目管理',
                    	url: '${pageContext.request.contextPath}/inject/injectPhoneZx/page',
        	 ...
        	 function showOperate(value,row,index){
	        	...
	        	function showPriorityDialog(id){
	        		$(parent).domain("openDialog",{
	        			iconCls:'icon-view',
	        			title:'设置优先级',
	        			src:"${pageContext.request.contextPath}/inject/injectPhoneZx/showPriority?id="+id,
	        			width:400,
	        			height:200,
	        			onClose:function(){
	        	...
	        	function showVideoDialog(seriesCode){
	        		$(parent).domain("openDialog",{
	        			iconCls:'icon-view',
	        			title:'设置剧集优先级',
	        			src:"${pageContext.request.contextPath}/inject/injectPhoneZx/videoIndex?seriesCode="+seriesCode,
	        			width:1100,
	        			height:600,
	        			onClose:function(){
	        				$('#phonealbuminfo').datagrid('load',{});
