...
<html>
    ...
    <body class="easyui-layout" style="visibility:hidden">
      <div data-options="region:'north',border:false,split:true" style="padding:0px; border-bottom:1px solid #99BBE8; height:38px; width:auto;">
             ...
             <a href="javascript:getmovieurl()" id="btnSearch" class="easyui-linkbutton" data-options="iconCls:'icon-search',plain:false,disabled:false">查询</a>
            </form>
        </div>
        <div data-options="region:'center',border:false" style="padding:0px;">
            <table id="movieurl"></table>
        </div>
        ...
        <script type="text/javascript"> 
            function getmovieurl() {
                ...
                if(typeof($.data(t[0], 'datagrid')) == 'undefined') {
                	...
                	t.domain('datagrid', {
                        title: '播放地址管理',
                    	url: '${pageContext.request.contextPath}/vod/system/vodmovie/page',
                    	queryParams: queryParams,
                    	toolbar: customToolbar,
                        columns: [[
                             {field: 'id', title: 'id', width: 100, sortable: true, align: 'center', hidden: true}
                             ,{field: 'title', title: '描述', width: 100, sortable: true, align: 'center', hidden: false}
                             ,{field: 'name', title: '播放字段', width: 100, sortable: true, align: 'center', hidden: false}
                             ,{field: 'levels', title: '级别', width: 100, sortable: true, align: 'center', hidden: false}
        	...
        	$(function(){
                ...
                $t = $("#movieurl");
               //加载数据
                if($.fn.domain.defaults.datagrid.auto) getmovieurl();
            });
        	...
        	function updateStatus(ids,status){
        		$.ajax({
                  	url:"${pageContext.request.contextPath}/vod/system/vodmovie/updateStatus",
                  	type:"GET",
                  	dataType:"JSON",
                  	data:{status:status,id:ids},
                  	async:false,
                  	success:function(){
                  		 top.$.messager.alert("信息", "操作成功！", "info", getmovieurl(), 2000); 
        	...
        	var sysBtnreset=$.extend($.fn.domain.reset,{
        		...
        		handler:function(){
        			$.ajax({
                      	url:"${pageContext.request.contextPath}/phonereset/resetmovieurl",
                      	type:"GET",
                      	dataType:"JSON",
                      	data:{},
                      	async:false,
