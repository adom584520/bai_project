...
public class VodAlbuminfoService implements IVodAlbuminfoService {
	...
	@Override
	public List<Map<String, Object>> findstatus(Map<String, Object> queryParams) {
		return vodAlbuminfoMapper.findstatus(queryParams);
	}

	@Override
	public int countstatus(Map<String, Object> queryParams) {
		return vodAlbuminfoMapper.countstatus(queryParams);
	}

	public int insertalbumstatusupdate(Map<String, Object> queryParams) {
		return vodAlbuminfoMapper.insertalbumstatusupdate(queryParams);
	}

	public int deletealbumstatusupdate(Map<String, Object> queryParams) {
		return vodAlbuminfoMapper.deletealbumstatusupdate(queryParams);
	}

	@Override
	public int updateaikanseriesname(Map<String, Object> queryParams) {
		return vodAlbuminfoMapper.updateaikanseriesname(queryParams);
	}

	@Override
	public int updatevideopaid(Map<String, Object> map) {
		return vodAlbuminfoMapper.updatevideopaid(map);
	}

	@Override
	public int updatejson(Vodalbuminfo vodalbuminfo) {
		return vodAlbuminfoMapper.updatejson(vodalbuminfo);
	}
