       ...
       <script type="text/javascript" src="/js/common/jquery-easyui-1.3.1/common.js"></script>
        <script type="text/javascript"> 
        	...
        	$(function(){
    			...
    			$table=$("#albuminfor");
                //加载数据
                if($.fn.domain.defaults.datagrid.auto) getalbuminfo();
            });
	               	        ...
	               	        $.messager.confirm('确认','确认删除？',function(r){
	               	        	if(r==false){return false;}
	    	     	        		$.ajax({
	    	                           	...
	    	                           	type:"GET",
	    	                           	dataType:"JSON",
	    	                           	data:{albumid:ids.substr(1,ids.length),id:"${id}"},
	    	                           	async:false,
	    	                           	success:function(){
	               	        ...
	               	        for (var i = 0; i < nodes.length; i++) {
	            	            ...
	            	            sequence+=","+nodes[i]["sequence"];
	    	     	        		...
	    	     	        		$.ajax({
	    	                           	...
	    	                           	type:"GET",
	    	                           	dataType:"JSON",
	    	                           	data:{albumid:ids.substr(1,ids.length),id:"${id}",sequence:sequence.substr(1,sequence.length)},
	    	                           	async:false,
	    	                           	success:function(){
	    	                           	 top.$.messager.alert("信息", "操作成功！", "info", null, 2000);            		
	    	                           	},
