...
public class VodbussinfoService implements IVodbussinfoService {
	...
	@Override
	public List<Map<String, String>> findHttp(Map<String, Object> queryParams) {
		//查项目ip
		List<Map<String, Object>> findHttp =vodbusschannelMapper.findHttp(queryParams);
		List<Map<String, String>> list = new ArrayList<Map<String, String>>();
		for (Map<String, Object> map : findHttp) {
			Map<String, String> mapChannel = new HashMap<String, String>();
			//查项目频道
			List<Integer> Channels=vodbusschannelMapper.bussChannel(map.get("bussId").toString());
			mapChannel.put("address", map.get("address").toString());
			mapChannel.put("channelCode", org.apache.commons.lang.StringUtils.join(Channels.toArray(),","));
			list.add(mapChannel);
		}
