package com.pbtd.launcher.servlet;
...
@WebServlet(urlPatterns = "/druid/*", initParams = {
		...
		@WebInitParam(name = "loginPassword", value = "druid_admin123456"), // 密码
		@WebInitParam(name = "resetEnable", value = "true")// 禁用HTML页面上的ResetAll功能
})
