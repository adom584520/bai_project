                ...
                //	var customToolbar = [$.fn.domain.create,'-',$.fn.domain.edit,'-',$.fn.domain.del,'-',saveBtn,'-',savestatusstartBtn,'-',savestatusendBtn];
                	...
                	t.domain('datagrid', {
                        ...
                        columns: [[
								...
								,{field: 'channel_id', title: '频道ID', width: 100, align: 'center', hidden: false}
								,{field: 'name', title: '名称', width: 100, align: 'center', hidden: false}
								,{field: 'target_code', title: '专辑id', width: 100, align: 'center', hidden: false}
								...
								,{field: 'update_user', title: '更新人', width: 100, align: 'center', hidden: false}
								...
								,{field: 'imageUrl', title: '图片Url', width: 100, align: 'center', hidden: false,
								...
								,{field: 'made', title: '操作图片', width: 100, align: 'center',value:'', hidden: false,
							    	formatter: function(value,row) { 
       	 ...
       	 var  sysBtns5=$.extend($.fn.domain.Btnsys5,{
       		...
       		handler: function() {
       			 ...
       			 if(curtime=="" || curtime==null){
       	      	...
       	      	$.ajax({
                      	url:"${pageContext.request.contextPath}/integrate/outputjson/phone/phonerecommandpicip",
                      	type:"GET",
                      	dataType:"JSON",
           		...
           		handler: function() {
           			$.messager.confirm('确认','确认删除？',function(r){
           				if(r){
    	   	        		...
    	   	        		$.ajax({
    	                         	url:"${pageContext.request.contextPath}/vod/system/recommandpic/deletes",
    	                         	type:"GET",
    	                         	dataType:"JSON",
