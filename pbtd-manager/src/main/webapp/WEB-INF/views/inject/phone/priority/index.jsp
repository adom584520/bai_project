         	...
         	<form id="formQuery" style="margin:0; padding:0" action="" method="post"> 
            		...
            		<label class="">频道：</label>
	            		<select id="channelCode" name="channelCode"  style="width: 120px;" class="chzn-select">
							...
							<c:forEach var="map" items="${listChannel}">
								<option value="${map.channelCode}">${map.channelName}</option>
							</c:forEach>
						</select>
					</span>
        ...
        <script type="text/javascript"> 
            function getinfo() {
                ...
                //	var customToolbar = [$.fn.domain.create,'-',$.fn.domain.edit,'-',$.fn.domain.del,'-',saveBtn,'-',savestatusstartBtn,'-',savestatusendBtn];
                	...
                	t.domain('datagrid', {
                        title: '优先级管理',
                    	url: '${pageContext.request.contextPath}/inject/phone/priority/page',
                        ...
                        columns: [[
	                    	...
	                    	,{field: 'channelName', title: '频道名称', width: 100, sortable: true, align: 'center'}
	                    	,{field: 'priority', title: '优先级设置', width: 100, sortable: true, align: 'center', hidden: false,formatter:showPriority}
	                    	,{field: 'updatetime', title: '更新时间', width: 100,  align: 'center', hidden: false,
