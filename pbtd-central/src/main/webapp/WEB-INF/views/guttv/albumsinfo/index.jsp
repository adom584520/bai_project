        ...
        <script type="text/javascript"> 
            function getinfo() {
                ...
                if(typeof($.data(t[0], 'datagrid')) == 'undefined') {
                	...
                	t.domain('datagrid', {
                        title: '合一源数据管理',
                    	url: '${pageContext.request.contextPath}/guttv/albums/page',
        ...
        function getisStorage(value){
        	 ...
        	 function getBtn(value, row, index, text){
			     ...
			     var status = row.isStorage;
			    	 ckButton = "<a name='show' onclick='show(\""+row.seriesCode+"\")' class='easyui-linkbutton'>查看</a>";
			     return ckButton;
	   		}
        	 //批量操作入库
        	 ...
        	 function savestatus(ids,type){
        		 var  url= '${pageContext.request.contextPath}/guttv/strategy/albuminfoid';	  	 
	  			 $.ajax({
	               	url:url,
	               	type:"POST",
	               	data:{id:ids,cp:4,type:type},
	               	dataType:"JSON",
        	 ...
        	 function show(code){
         		$(parent).domain("openDialog", { 
     	        	iconCls: "icon-view", 
     	        	title: "查看", 
     	        	src: "${pageContext.request.contextPath}/guttv/albums/show/"+code,
     	        	width: 1060, 
    	        	height: 550,
     	        	onClose: function() { 
     	            }
	        	...
	        	function choosechannel(){
	                   	$.ajax({
	                       	url:"${pageContext.request.contextPath}/pbtd/dictionary/choosechannelguttv",
	                       	type:"GET",
	                       	dataType:"JSON",
	                       	data:{level:1},
	                       	async:false,
	        	...
	        	function choosechannellabel(value){
	                   	$.ajax({
	                       	url:"${pageContext.request.contextPath}/pbtd/dictionary/choosechannellabelguttv",
	                       	type:"GET",
	                       	dataType:"JSON",
	                       	data:{chnId:value},
	                       	async:false,
