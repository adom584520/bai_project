...
<title>登录页面</title>
<link rel="stylesheet" type="text/css" href="/js/albuminfo/login/css/normalize.css" />
<link rel="stylesheet" type="text/css" href="/js/albuminfo/login/css/demo.css" />
<!--必要样式-->
<link rel="stylesheet" type="text/css" href="/js/albuminfo/login/css/component.css" />
...
<body>
	...
	<script src="/js/albuminfo/login/js/TweenLite.min.js"></script>
	<script src="/js/albuminfo/login/js/EasePack.min.js"></script>
	<script src="/js/albuminfo/login/js/rAF.js"></script>
	<script src="/js/albuminfo/login/js/demo-1.js"></script>
	<script src="/js/albuminfo/login/js/login.js"></script>
</body>
</html>