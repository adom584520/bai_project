...
public class VodTvAlbuminfoService implements IVodTvAlbuminfoService {
	...
	@Override
	public List<VodTvAlbuminfo> page(int start, int limit, Map<String, Object> queryParams) {

		return vodTvAlbuminfoMapper.page(start, limit, queryParams);
	}
	...
	@Override
	public int insertjson(VodTvAlbuminfo vodTvAlbuminfo) {
		return vodTvAlbuminfoMapper.insertjson(vodTvAlbuminfo);
	}

	@Override
	public int insertvideojson(Map<String, Object> queryParams) {
		return vodTvAlbuminfoMapper.insertvideojson(queryParams);
	}
