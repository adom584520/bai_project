...
public interface IVodHotseriesService {
	//执播
	...
	//查询下发专辑接口
    List<Map<String,Object>> findforinterface(Map<String,Object> queryParams);
	//绑定专辑
	List<Map<String,Object>> pagealbum(Map<String,Object> queryParams);
	List<Map<String,Object>> findhotseriesalbum(Map<String,Object> queryParams);
