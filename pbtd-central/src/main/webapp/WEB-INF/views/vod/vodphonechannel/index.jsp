        ...
        <script type="text/javascript"> 
            function getVodChannels() {
                ...
                if(typeof($.data(t[0], 'datagrid')) == 'undefined') {
                		var customToolbar = [$.fn.domain.create,'-',$.fn.domain.edit,'-',$.fn.domain.del,'-',savestatusstartBtn,'-',savestatusendBtn];
                		 //var customToolbar = [$.fn.domain.create,'-',$.fn.domain.edit,'-',$.fn.domain.del];
              
                	t.domain('datagrid', {
                        title: '频道管理',
                    	url: '${pageContext.request.contextPath}/integrate/vodphonechannel/page',
                    	queryParams: queryParams,
                    	toolbar: customToolbar,
                        columns: [[
	                    	{field: 'id', title: ' ', width: 100, sortable: true, align: 'center', hidden: true}
	                    //	,{field: 'parentname', title: '频道', width: 100, sortable: true, align: 'center', hidden: false}
        	...
        	$(function(){
        	 ...
        	 function savestatus(ids,type){
        		 var params = {};
	  			 params.ids = ids;
	  			 params.type = type; 
        		 var  url= '${pageContext.request.contextPath}/integrate/vodphonechannel/savestatus';	  	 
	  			 $.ajax({
	               	url:url,
	               	type:"POST",
	    	 ...
	    	 var saveBtn = $.extend($.fn.domain.saveGrid,{
	  		 ...
	  		 function saveSubmit(rows,flag){
	  			 var params = {};
	  			 params.rows = rows;
	  			 var  url= '${pageContext.request.contextPath}/integrate/vodphonechannel/save';	  	 
	  			 $.ajax({
	               	url:url,
	               	type:"POST",
	               	data:$.serialize(params),
