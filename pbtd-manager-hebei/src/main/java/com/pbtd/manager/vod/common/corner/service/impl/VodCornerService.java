...
public class VodCornerService implements IVodCornerService {
	...
	@Override
	public List<VodCorner> page(int start, int limit, Map<String, Object> queryParams) {
	
		return vodCornerMapper.page(start, limit, queryParams);
	}
	...
	@Override
	public int insertjson(VodCorner vodCorner) {
		// TODO Auto-generated method stub
		return vodCornerMapper.insertjson(vodCorner);
	}
}
