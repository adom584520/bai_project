        ...
        <script type="text/javascript"> 
            function getalbumin() {
                ...
                if(typeof($.data(t[0], 'datagrid')) == 'undefined') {
                	...
                	t.domain('datagrid', {
                        title: 'phone节目管理',
                    	url: '${pageContext.request.contextPath}/inject/injectTvZx/videopage/'+seriesCode,
                        ...
                        columns: [[
	                    	...
	                    	,{field: 'operate',  title: '操作', width: 250,  align: 'center', hidden: false,formatter: showOperate}
	                    ]],
        	...
        	function showOperate(value,row,index){
        		...
        		if(value==-1){
		     	...
		     	str+="&nbsp;&nbsp;&nbsp;";
		     	str+="<button onclick=sendInject("+row.vodId+")>注入</button>";
		     	return btnPriority+str;
        	}
	        ...
	        function choosechannellabel(value){
	        	...
	        	function showPriorityDialog(id){
	        		$(parent).domain("openDialog",{
	        			iconCls:'icon-view',
	        			title:'设置优先级',
	        			src:"${pageContext.request.contextPath}/inject/injectTvZx/showVideoPriority?id="+id,
	        			width:400,
	        			height:200,
	        			onClose:function(){
	        	...
	        	function sendInject(vodId){
	        		$.ajax({
	        			type:'post',
	        			url:'${pageContext.request.contextPath}/inject/injectTvZx/SendOutAlbumVideo',
	        			data:{
	        				vodId:vodId
	        			},
	        			dataType:'json',
