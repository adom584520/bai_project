...
<div data-options="region:'center',border:false" style="padding:0px;">
    <form id="bottomnavigation"  accept-charset="utf-8" style="margin:10px; padding:0; visibility:hidden" method="post" autoTypeset="false" columnSize="2">
	<input type="hidden" id="id" name="id" />
			<table width="98%" cellspacing="1" cellpadding="3" class="tblMain" align="center">
				<tr>
					...
					<td class="tdContent"> 
					<input type="text" id="type" name="type"   class="easyui-validatebox" validType="integer" required="true" missingMessage="请输入，必须为整数">
					 </td>
				</tr>
				<tr>
				  <td style="text-align: right; width: 20%"   style="width: 120px;" class="tdCaption"  align="center">
					...
					<td class="tdContent"> 
					<input type="text" id="name" name="name"   class="easyui-validatebox" validType="String " required="true" missingMessage="请输入，必须为文字">
				 </td>
				</tr>				
		</table>
...
<script type="text/javascript">
	//页面初始化
   	$(function(){
	        ...
	        var t = $('#bottomnavigation');
	        //加载数据
	        t.domain('load', {
	            url: '${pageContext.request.contextPath}/vod/system/bottomnavigation/load/'+id,
	            names: [],
	    ...
	    var  url= '${pageContext.request.contextPath}/vod/system/bottomnavigation/'+($.query.getId()=="0"?'create':'edit/'+id);  
		     t.domain('edit', {
	             title: ' ',
	             url: url,
	             data: data,
