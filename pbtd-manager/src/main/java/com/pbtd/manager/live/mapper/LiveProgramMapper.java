...
public interface LiveProgramMapper {
	List<LiveProgram> selectByPrimaryKey(LiveProgram record);
	LiveProgram selectByrecord(LiveProgram record);
	...
	int deletebyreal(Map<String, Object> ids);
	 ...
	 * @return 被修改的记录数
	 */
	int update(LiveProgram record);
	
	
	List<LiveProgram> getprogram(int bussid);
