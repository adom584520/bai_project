...
<body class="easyui-layout" style="visibility: hidden">
		...
		<table width="98%" cellspacing="1" cellpadding="3" class="tblMain"
			...
			<tr>
				<td style="text-align: right; width: 15%" class="tdCaption"
					align="center">播放剧集</td>
				<td class="tdContent" style="width: 60%;">${map.sequence}</td>
				<td class="tdContent" colspan="2" rowspan="5"
					style="text-align: right;">
					<div class="aixuexi" style="height: 150px;">
						<img id="pic" name="pic" style="margin-right: 2px;"
							src="${map.thumb_url}" />
					</div>
				</td>
			</tr>
			<tr>
				<td style="text-align: right; width: 15%" class="tdCaption"
					align="center">剧集名称</td>
				<td class="tdContent">${map.title}</td>
			</tr>
			<tr>
				<td style="text-align: right; width: 15%" class="tdCaption"
					align="center">类型</td>
				<td class="tdContent">${map.video_type}</td>
			</tr>
			<tr>
				<td style="text-align: right; width: 15%" class="tdCaption"
					align="center">剧集简介</td>
				<td class="tdContent"></td>
			</tr>
			<tr>
				<td style="text-align: right; width: 15%" class="tdCaption"
					align="center">播放时长</td>
				<td class="tdContent">${map.duration}</td>
			</tr>
			<tr>
				<td style="text-align: right; width: 15%" class="tdCaption"
					align="center">播放地址</td>
				<td class="tdContent" colspan="3"></td>
			</tr>
			<tr>
				<td style="text-align: right; width: 15%" class="tdCaption"
					align="center">文件流地址</td>
				<td class="tdContent" colspan="3"><textarea
						style="width: 60%; height: 90px;" rows="60" cols="4">
				</textarea></td>
			</tr>
		</table>
	</div>
	...
	<div data-options="region:'south',border:false"
		...
		<a id="btnClose"
			href="javascript:void($(parent).domain('closeDialog'))"
