...
<div data-options="region:'center',border:false" style="padding:0px;">
	...
	<input type="hidden" id="id" name="id" />
			...
			节目单编号
					...
					<td class="tdContent">
				<input id="programid" name="programid" <c:if test="${id>0 }"> type="text" disabled="disabled" </c:if>  class="input text easyui-validatebox-disable" style="" data-options="validType:'text[1,127]',required:true" />
					</td>
				</tr>
			</c:if> 
			<tr>
		...
		节目来源
				...
				<td class="tdContent">
		<input type="text" id="source"name="source" class="input text easyui-validatebox-disable" style="" data-options="validType:'text[1,127]',required:true"  />	
	</td>
			</tr>
			<tr>
				<td style="text-align: right; width: 15%"  class="tdCaption"  align="center">
		节目开始时间
				...
				<td class="tdContent">
		<input type="text" id="starttime"name="starttime" class="input text easyui-validatebox-disable" style="" data-options="validType:'text[1,127]',required:true"  />	
				</td>
			</tr>
			<tr>
				<td style="text-align: right; width: 15%"  class="tdCaption"  align="center">
		节目结束时间
				...
				<td class="tdContent">
		<input type="text" id="endtime"name="endtime" class="input text easyui-validatebox-disable" style="" data-options="validType:'text[1,127]',required:true"  />	
	</td>
			</tr>
			<tr>
				<td style="text-align: right; width: 15%"  class="tdCaption"  align="center">
		节目频道
				...
				<td class="tdContent">
		<input type="text" id="chncode" name="chncode" class="input text easyui-validatebox-disable" style="" data-options="validType:'text[1,127]',required:true"  />	
	</td>
			</tr>
			<tr>
				<td style="text-align: right; width: 15%"  class="tdCaption"  align="center">
		节目名称
				...
				<td class="tdContent">
		<input type="text" id="programname"name="programname" class="input text easyui-validatebox-disable" style="" data-options="validType:'text[1,127]',required:true"  />	
	</td>
			</tr>
			<tr>
				<td style="text-align: right; width: 15%"  class="tdCaption"  align="center">
		节目播放时间
				...
				<td class="tdContent">
		<input type="text" id="realtime"name="realtime" class="input text easyui-validatebox-disable" style="" data-options="validType:'text[1,127]',required:true"  />	
	</td>
			</tr>
			</table>
    </form>
...
<script type="text/javascript">
	//页面初始化
   	$(function(){
	        ...
	        //加载数据
	        t.domain('load', {
	            url: '${pageContext.request.contextPath}/live/Program/load/' + id,
	            names: [],
	    ...
	    //如果id为0，是要创建一条新记录，否则是修改
	    var  url= '${pageContext.request.contextPath}/live/Version/'+($.query.getId()=="0"?'create':'edit/'+id);  
		     t.domain('edit', {
	             title: ' ',
	             url: url,
	             data: data,
