...
<div data-options="region:'center',border:false" style="padding:0px;">
	...
	<input type="hidden" id="id" name="id" />
		...
		说明
				...
				<td class="tdContent">
				<input type="text" id="instruction"name="instruction" class="input text easyui-validatebox-disable"       style="" data-options="validType:'text[1,30]',required:true" />
				</td>
			</tr>
		</table>
    </form>
...
<script type="text/javascript">
	//页面初始化
   	$(function(){
	        ...
	        //加载数据
	        t.domain('load', {
	            url: '${pageContext.request.contextPath}/vod/system/vodlogo/load/' + id,
	            names: [],
	    ...
	    var  url= '${pageContext.request.contextPath}/vod/system/vodlogo/'+($.query.getId()=="0"?'create':'edit/'+id);  
		     t.domain('edit', {
	             title: ' ',
	             url: url,
	             data: data,
