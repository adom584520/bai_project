        ...
        <script type="text/javascript"> 
                ...
                //	var customToolbar = [$.fn.domain.create,'-',$.fn.domain.edit,'-',$.fn.domain.del,'-',saveBtn,'-',savestatusstartBtn,'-',savestatusendBtn];
                	...
                	t.domain('datagrid', {
                        ...
                        columns: [[
								...
								,{field: 'imgNor', title: '未点击图片', width: 100, sortable: true, align: 'center', hidden: false,
								...
								,{field: 'imgSelect', title: '已点击图片', width: 100, sortable: true, align: 'center', hidden: false,
								...
								,{field: 'madeNor', title: '操作未点击图片', width: 100, sortable: true, align: 'center', hidden: false,
        	...
        	$(function(){
         	...
         	var sysBtnreset=$.extend($.fn.domain.reset,{
         		...
         		handler:function(){
         			$.ajax({
                       	url:"${pageContext.request.contextPath}/phonereset/resetbottomnavigation",
                       	type:"GET",
                       	dataType:"JSON",
                       	data:{},
                       	async:false,
