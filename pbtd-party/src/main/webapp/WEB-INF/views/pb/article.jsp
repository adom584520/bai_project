...
<script type="text/javascript" src="/js/pb/article.js"></script>
</head>
	...
	<div data-options="region:'north',border:false,split:true" style="padding:10px; border-bottom:0px solid #99BBE8; height:50px; width:auto;">
       	<span class="property">
        	分组：<input id="groupIdSearch" name="groupId" class="easyui-combobox" style="width: 140px; height: 25px">
       		类型：<input id="typeSearch" name="type" class="easyui-combobox" style="width: 140px; height: 25px">
       	</span>
		...
		<form id="addOrEditFrom" method="post">
			...
			<div align="center" style="padding-top:10px">
				<table>
					...
					<tr style="height: 30px">
						<td>
							选择类型：<input id="type" name="type" class="easyui-combobox" style="width: 120px;height:25px">
						</td>
					</tr>
					<tr style="height: 30px">
						<td>
							标题：<input id="title" name="title" class="easyui-textbox" style="width: 150px;height:25px">
						</td>
					</tr>
					<tr style="height: 30px">
						<td>
							内容文本：<input id="content" name="content" class="easyui-textbox" style="width: 150px;height:25px">
						</td>
					</tr>
				</table>
			</div>
		...
		<div id="imageEditDiv">
			...
			<table id="imageTable" style="padding-top: 5px;padding-left: 10px">
				<tr style="width: 482;height: 28" align="center">
					<td>
						内容图：<input class="easyui-validatebox textbox" style="width: 160px;height:25px">
