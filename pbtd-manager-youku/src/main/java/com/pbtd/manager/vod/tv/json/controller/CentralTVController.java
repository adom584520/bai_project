		...
		public void phonechannel(HttpServletRequest request) {
			...
			for (int ii = 0; ii < result.size(); ii++) {
				...
				try {
					...
					centralTvService.Addtvchannel(id,channelName,channelCode);
				} catch (Exception e) {
	...
	public void InsertCentral() {
		...
		while (true) {
			...
			for (VodjsonTvAlbuminfo vodTvAlbuminfo : testList) {
				System.out.println(vodTvAlbuminfo.getSeriesname() + "......");
				vodTvAlbuminfo.setCpseriescode(vodTvAlbuminfo.getSeriescode().toString());
				try {
					centralTvService.getInsertUpdate(vodTvAlbuminfo);
				} catch (Exception e) {
