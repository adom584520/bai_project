	    ...
	    <form id="addAndEditForm"  accept-charset="utf-8" style="margin:10px; padding:0; visibility:hidden" method="post" autoTypeset="false" columnSize="2">
			...
			<table width="98%" cellspacing="1" cellpadding="3" class="tblMain" align="center">
				...
				<tr>
					...
					<td class="tdContent"> 
						<select id="showType" name="showType"  style="width: 120px;height: 25px">
							<option value="" selected="selected">请选择</option>
				...
				<tr>
					...
					<td class="tdContent"> 
						<input type="text" id="targetCode" name="targetCode" class="easyui-validatebox" validType="text[0,50]" required="true" missingMessage="请输入点播或直播的ID" style="width:120px; height: 24px">
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="tdContent">
						<input type="text" id="skipTime" name="skipTime" value='3' class="easyui-validatebox" required="true" validType='text[1,50]' missingMessage="请输入跳过时间，单位秒" style="width:160px; height: 24px">
					</td>
				</tr>
				<tr>
					<td style="text-align: right; width: 20%" class="tdCaption" align="center">
	...
	<script type="text/javascript">
		//页面初始化
	   	$(function(){
	        ...
	        //加载数据
	        t.domain('load', {
	            url: '${pageContext.request.contextPath}/vod/phone/startslideshow/queryById/'+id,
	            names: [],
	        ...
	        function save() {
			    ...
			    var  url= '${pageContext.request.contextPath}/vod/phone/startslideshow/'+($.query.getId()=="0"?'insert':'update/'+id);  
				t.domain('edit', {
					url: url,
					data: data,
					onLoadSuccess: function(data, status, XHR) {
