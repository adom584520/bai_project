...
@Controller
@RequestMapping("/cpAlbuminfoJoin")
public class CpAlbuminfoJoinController {
	private static final Logger LOGGER = LoggerFactory.getLogger(CpAlbuminfoJoinController.class);
	@Autowired
	private AlbuminfoService albuminfoService;

	@RequestMapping("page")
	public String page(Long id, String cpCode, Long cpAlbuminfoId, Model model) {
		model.addAttribute("albuminfoJoinId", id);
