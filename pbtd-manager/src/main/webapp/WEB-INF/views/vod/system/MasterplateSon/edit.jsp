...
<div data-options="region:'center',border:false" style="padding:0px;">
	...
	<input type="hidden" id="id" name="id" />
		...
		名称
				...
				<td class="tdContent">
				<input type="text" id="name" name="name"  class="input text easyui-validatebox-disable"    style="" data-options="validType:'text[1,10]',required:true" />
				</td>
			</tr>
			<tr>
		...
		返回条数
				...
				<td class="tdContent">
		<input type="text" id="count" name="count"class="easyui-numberbox"   style="width: 60px" data-options="min:1,max:999,required:true" />	
	</td>
			</tr>
			 <tr>
				<td style="text-align: right; width: 15%"  class="tdCaption"  align="center">
...
<script type="text/javascript">
	//页面初始化
   	$(function(){
	        ...
	        //加载数据
	        t.domain('load', {
	            url: '${pageContext.request.contextPath}/vod/MasterplateSon/load/' + id,
	            names: [],
	    ...
	    var  url= '${pageContext.request.contextPath}/vod/MasterplateSon/'+($.query.getId()=="0"?'create':'edit/'+id);  
		     t.domain('edit', {
	             title: ' ',
	             url: url,
	             data: data,
