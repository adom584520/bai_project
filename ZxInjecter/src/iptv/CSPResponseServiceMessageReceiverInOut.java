...
public class CSPResponseServiceMessageReceiverInOut extends
		...
		try {
			...
			if ((op.getName() != null)
				...
				if ("resultNotify".equals(methodName)) {
					...
					iptv.ResultNotifyResponse resultNotifyResponse3 = null;
					iptv.ResultNotify wrappedParam = (iptv.ResultNotify) fromOM(
							msgContext.getEnvelope().getBody()
									.getFirstElement(),
							iptv.ResultNotify.class,
							getEnvelopeNamespaces(msgContext.getEnvelope()));

					resultNotifyResponse3 =

					skel.resultNotify(wrappedParam);

					envelope = toEnvelope(getSOAPFactory(msgContext),
							resultNotifyResponse3, false,
	...
	private org.apache.axiom.om.OMElement toOM(iptv.ResultNotifyResponse param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {
	...
	private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
		...
		try {
			...
			emptyEnvelope.getBody().addChild(
					param.getOMElement(iptv.ResultNotifyResponse.MY_QNAME,
							factory));
	...
	private java.lang.Object fromOM(org.apache.axiom.om.OMElement param,
		...
		try {
			...
			if (iptv.ResultNotify.class.equals(type)) {
				...
				return iptv.ResultNotify.Factory.parse(param
			...
			if (iptv.ResultNotifyResponse.class.equals(type)) {
				...
				return iptv.ResultNotifyResponse.Factory.parse(param
						.getXMLStreamReaderWithoutCaching());
