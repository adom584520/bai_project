        ...
        <script type="text/javascript">
            function getcpsource() {
                ...
                if(typeof($.data(t[0], 'datagrid')) == 'undefined') {
                	var customToolbar = [$.fn.domain.create,'-',$.fn.domain.edit,'-',$.fn.domain.del,'-',sys1btn,'-'];
                	t.domain('datagrid', {
                        //title: ' ',
                    	url: '${pageContext.request.contextPath}/system/cpsource/page',
        	...
        	var sys1btn=$.extend($.fn.domain.Sysbtn1,{
        		 title:"下发",
	    	        text:"下发",
	    	        iconCls:"icon-ok",
	        		handler:function(){	        	    
	        	    	var ids = "";
	        			$.ajax({
	                      	url:"${pageContext.request.contextPath}/integrate/outputjson/phone/phonesourcetype/"+ids,
	                      	type:"GET",
	                      	dataType:"JSON",
	                      	data:{},
	                      	async:false,
