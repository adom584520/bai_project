...
public class LauncherGroupServiceImpl implements LauncherGroupService {
	...
	public void delete(Long id) {
		...
		ids.add(id);
		launcherUIService.updateDataStatus(ids, LauncherConstant.LAUNCHER_DATA_STATUS_INVALID);
		advertisementService.updateDataStatus(ids, LauncherConstant.LAUNCHER_DATA_STATUS_INVALID);
		navigationService.updateDataStatus(ids, LauncherConstant.LAUNCHER_DATA_STATUS_INVALID);
	}
