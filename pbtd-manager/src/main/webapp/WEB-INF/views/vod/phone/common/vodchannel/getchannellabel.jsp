        ...
        <script type="text/javascript"> 
            function getinfo() {
                ...
                //	var customToolbar = [$.fn.domain.create,'-',$.fn.domain.edit,'-',$.fn.domain.del,'-',saveBtn,'-',savestatusstartBtn,'-',savestatusendBtn];
                	...
                	t.domain('datagrid', {
                        title: '频道绑定标签管理',
                    	url: '${pageContext.request.contextPath}/vod/phone/Vodchannel/getchannellabelpage',
                    	queryParams: queryParams,
                    	toolbar: customToolbar,
                        columns: [[
	                    	{field: 'id', title: '标识', width: 100, sortable: true, align: 'center', hidden:true}
	                    	,{field: 'type', title: '标签分类id', width: 100, sortable: true, align: 'center', hidden: true}
    		...
    		var sysBtndel = $.extend($.fn.domain.del,{
					...
					$.ajax({
								url : "${pageContext.request.contextPath}/vod/phone/Vodchannel/deletebindinglabel",
								type : "GET",
								dataType : "JSON",
			...
			$(parent).domain("openDialog",{
				iconCls : "icon-view",
				title : "添加",
				src : "${pageContext.request.contextPath}/vod/phone/Vodchannel/addchannellabel/"+"${channel}",
				width : 1250,
				height : 650,
				onClose: function() { 
					getinfo(); 
       				...
       				nodes = $table.datagrid("getChanges");
              	        ...
              	        for (var i = 0; i < nodes.length; i++) {
           	            ...
           	            labeltype+=","+nodes[i]["type"]
   	     	        		...
   	     	        		$.ajax({
   	                           	url:"${pageContext.request.contextPath}/vod/phone/Vodchannel/updatelabelsequence",
   	                           	type:"GET",
   	                           	dataType:"JSON",
