        ...
        <script type="text/javascript"> 
            function getinfo() {
                ...
                //	var customToolbar = [$.fn.domain.create,'-',$.fn.domain.edit,'-',$.fn.domain.del,'-',saveBtn,'-',savestatusstartBtn,'-',savestatusendBtn];
                	var customToolbar = [$.fn.domain.create,'-',$.fn.domain.edit,'-',$.fn.domain.del,'-',sysBtnup,'-',sysBtnno,'-',sysBtn,'-',sysBtnbq,'-',sysBtns5,'-',sysBtn4,'-'];
                	t.domain('datagrid', {
                        title: '频道管理',
                        ...
                        columns: [[
	                    	...
	                    	,{field : 'labelType',title : '标签归属分类',width : 80,sortable : true,align : 'center',hidden : false}
	                    	,{field : 'img',title : '图片',width : 100,sortable : true,align : 'center',hidden : false,formatter : getimgurl}
    	 ...
    	 var  sysBtn=$.extend($.fn.domain.Btnsys,{
    		...
    		handler: function() {
    	    	...
    	    	if(nodes.length>1){
    	    		 top.$.messager.alert("信息", "请您选择一条信息", "info", null, 2000);
    	    		 return;
    	    	}
    	    //	if( nodes[0]["levels"]==1){
    	    ...
    	    //	}
    	    	...
    	    	$(parent).domain("openDialog", { 
     	        	iconCls: "icon-view", 
     	        	title: "绑定", 
     	        	src: "${pageContext.request.contextPath}/vod/phone/Vodchannel/albuminfo/"+id+"?parentCode="+parentCode+"&channelName="+channelName+"&levels="+levels+"&channel="+channel,
     	        	width: 1250, 
    	        	height: 650,
     	        	onClose: function() {
    	 ...
    	 var  sysBtns5=$.extend($.fn.domain.Btnsys5,{
    		...
    		handler: function() {
    			 ...
    			 if(curtime=="" || curtime==null){
    	      	...
    	      	$.ajax({
                   	url:"${pageContext.request.contextPath}/integrate/outputjson/phone/phonechannelip",
                   	type:"GET",
                   	dataType:"JSON",
