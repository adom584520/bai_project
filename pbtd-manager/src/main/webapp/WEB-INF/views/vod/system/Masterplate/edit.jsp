...
<div data-options="region:'center',border:false" style="padding:0px;">
	...
	<input type="hidden" id="id" name="id" />
		...
		名称
				...
				<td class="tdContent">
				<input type="text" id="masterplatename" name="masterplatename"  class="input text easyui-validatebox-disable"    style="" data-options="validType:'text[1,10]',required:true" />
				</td>
			</tr>
			<tr>
		...
		运营位个数
				...
				<td class="tdContent">
		<input type="text" id="masterplatenum" name="masterplatenum"class="easyui-numberbox"   style="width: 60px" data-options="min:1,max:999,required:true" />	
	</td>
			</tr>
		 ...
		 说明
				...
				<td class="tdContent">
		<input type="text" id="describes" name="describes" class="input text easyui-validatebox-disable" style="" data-options="validType:'text[1,127]'" />	
	</td>
			</tr>
			</table>
    </form>
...
<script type="text/javascript">
	//页面初始化
   	$(function(){
	        ...
	        //加载数据
	        t.domain('load', {
	            url: '${pageContext.request.contextPath}/vod/Masterplate/load/' + id,
	            names: [],
	    ...
	    var  url= '${pageContext.request.contextPath}/vod/Masterplate/'+($.query.getId()=="0"?'create':'edit/'+id);  
		     t.domain('edit', {
	             title: ' ',
	             url: url,
	             data: data,
