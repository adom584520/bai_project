...
<body class="easyui-layout" style="visibility: hidden">
	...
	<td  style="text-align: right; width: 15%"  class="tdCaption"  align="center">
		...
		导演
				...
				<td class="tdContent" colspan="3">
				<input type="hidden" id="actor" name=""/>
	             ...
	             onLoadSuccess: function(data, status, XHR) {
	              ...
	              //更改图片按钮
	    	       $("#pic1").linkbutton('enable')[0].onclick=function(){upload(id,1);};
	                ...
	                $("#pictureurl5").attr("src",img+data.pictureurl5);
	                $("#pictureurl6").attr("src",img+data.pictureurl6);
	                $("#pictureurl7").attr("src",img+data.pictureurl7);
	        ...
	        function save( ) {
	            ...
	            var channel=document.getElementById("channel");
	    		 ...
	    		 /*  var channel2=document.getElementById("channel2");
	    		  da+ta.channelName2=channel.options[channel2.selectedIndex].text; */
