...
<div data-options="region:'center',border:false" style="padding:0px;">
	...
	<input type="hidden" id="id" name="id" />
		...
		唯一标识
				...
				<td class="tdContent">
				<input type="text" id="channelCode"name="channelCode" disabled="disabled"  <c:if test="${id >0 }">disabled="disabled"</c:if> class="easyui-numberbox"    style=""  data-options="min:10000,max:9999999999,required:true" />
				</td>
			</tr>
			<tr>
				<td style="text-align: right; width: 15%"   style="width: 120px;" class="tdCaption"  align="center">
