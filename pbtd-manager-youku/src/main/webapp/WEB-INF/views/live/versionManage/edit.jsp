...
<div data-options="region:'center',border:false" style="padding:0px;">
	...
	<input type="hidden" id="id" name="id" />
			...
			版本号
					...
					<td class="tdContent">
				<input id="versionid" name="versionid" <c:if test="${id>0 }"> type="text" disabled="disabled" </c:if>  class="input text easyui-validatebox-disable" style="" data-options="validType:'text[1,127]',required:true" />
		...
		版本名称
				...
				<td class="tdContent">
		<input type="text" id="versionname"name="versionname" class="input text easyui-validatebox-disable" style="" data-options="validType:'text[1,127]',required:true"  />	
	</td>
			</tr>
			<tr>
				<td style="text-align: right; width: 15%"  class="tdCaption"  align="center">
		台号显示类型
				...
				<td class="tdContent">
		<select id="showtype" name="showtype" style="width: 120px;" class="chzn-select">
						<option value="0">显示数字台号</option>
						<option value="1">显示频道名称</option>
						<option value="2">显示频道图标</option>
						<option value="3">数字、名称、台标都不显示</option>
					</select>
	</td>
			</tr>
		 ...
		 是否支持数字换台
				...
				<td class="tdContent">
				<select id="isnumchanage" name="isnumchanage" style="width: 120px;" class="chzn-select">
						<option value="0">不支持数字换台</option>
						<option value="1">支持数字换台</option>
					</select>
	</td>
			</tr>
		...
		是否弹出播放继续框
				...
				<td class="tdContent">
				<select id="isplaycontinue" name="isplaycontinue" style="width: 120px;" class="chzn-select">
						<option value="0">弹出播放继续框</option>
						<option value="1">不弹出播放继续框</option>
					</select>
	</td>
			</tr>
			<tr>
		 ...
		 是否显示直播列表
				...
				<td class="tdContent">
				<select id="isshowlivelist" name="isshowlivelist" style="width: 120px;" class="chzn-select">
						<option value="0">不显示直播列表</option>
						<option value="1">显示直播列表</option>
					</select>
	</td>
			</tr>
			<tr>
		 ...
		 状态
				...
				<td class="tdContent">
				<select id="state" name="state" style="width: 120px;" class="chzn-select">
...
<script type="text/javascript">
	//页面初始化
   	$(function(){
	        ...
	        //加载数据
	        t.domain('load', {
	            url: '${pageContext.request.contextPath}/live/Version/load/' + id,
	            names: [],
