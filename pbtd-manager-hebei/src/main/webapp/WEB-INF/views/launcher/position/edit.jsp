...
<div data-options="region:'center',border:false" style="padding:0px;">
    <form id="form"  accept-charset="utf-8" style="margin:10px; padding:0; visibility:hidden" method="post" autoTypeset="false" columnSize="2">
	...
	<input type="hidden" id="position_name" name="position_name"/>
			<table width="98%" cellspacing="1" cellpadding="3" class="tblMain" align="center">
				...
				<tr>
					...
					<td class="tdContent"> 
					<input type="text" id="position" name="position"   class="easyui-validatebox" validType="integer" required="true" missingMessage="请输入，必须为整数">
					 </td>
				</tr>				
		</table>
...
<script type="text/javascript">
	//页面初始化
   	$(function(){
	        ...
	        //加载数据
	        t.domain('load', {
	            url: '${pageContext.request.contextPath}/launcher/position/load/'+id,
	            names: [],
        ...
        function save() {
            ...
            if(position_type!=null && position_type!=''){
          	  var position_name=$("#position_type").find("option:selected").text();
	    ...
	    var  url= '${pageContext.request.contextPath}/launcher/position/'+($.query.getId()=="0"?'create':'edit/'+id);  
		     t.domain('edit', {
	             title: ' ',
	             url: url,
	             data: data,
