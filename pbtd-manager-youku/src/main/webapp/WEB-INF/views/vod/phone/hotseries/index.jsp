      ...
      <div data-options="region:'north',border:false,split:true" style="padding:0px; border-bottom:1px solid #99BBE8; height:38px; width:auto;">
      	<form id="formQuery" style="margin:0; padding:0" action="" method="post"> 
				 <span class="property">
						...
						<a href="javascript:getforminfo()" id="btnSearch" class="easyui-linkbutton" data-options="iconCls:'icon-search',plain:false,disabled:false">查询</a>
				 </span>
        </form>
      </div>
            ...
            function getforminfo() {
                ...
                if(typeof($.data(t[0], 'datagrid')) == 'undefined'){
             	//var customToolbar = [$.fn.domain.create,'-',$.fn.domain.edit,'-',$.fn.domain.del,'-',saveBtn,'-',savestatusstartBtn,'-',savestatusendBtn];
                	var customToolbar = [$.fn.domain.create,'-',$.fn.domain.edit,'-',sysBtndel,sysBtnup,'-',sysBtnno,'-',sysBtn,'-',sysBtnreset];
                	t.domain('datagrid', {
                		title:'热搜管理',
                    	...
                    	idField:"id",
                    	columns: [[
							{field: 'id', title: '唯一标识', width: 100, sortable: true, align: 'center'}
						   ,{field: 'name', title: '热播名称', width: 100, sortable: true, align: 'center'}
						   ,{field: 'channelCode', title: '频道', width: 100, sortable: true, align: 'center'}
						   ,{field: 'count', title: '显示条数', width: 100, sortable: true, align: 'center'}
						   ,{field: 'type', title: '模板', width: 100, sortable: true, align: 'center'}
						   ...
						   ,{field: 'create_user', title: '创建人', width: 100, sortable: true, align: 'center'}
						   ...
						   ,{field: 'update_user', title: '更新人', width: 100, sortable: true, align: 'center'}
       ...
       //同步
       	var sysBtnreset=$.extend($.fn.domain.reset,{
       		...
       		handler:function(){
       			$.ajax({
                     	url:"${pageContext.request.contextPath}/phonereset/resethotseries",
                     	type:"GET",
                     	dataType:"JSON",
                     	data:{},
                     	async:false,
