...
<script type="text/javascript">
	//页面初始化
   	$(function(){
	      ...
	      //加载数据
	        t.domain('load', {
	            url: '${pageContext.request.contextPath}/vod/tv/vodalbuminfo/loadvideo/'+id,
	            names: [],
	      ...
	      //保存
		    function save() {	
		        ...
		        var url="";
		        if(id==-1){
		        	var url='${pageContext.request.contextPath}/vod/tv/vodalbuminfo/insertvideo/'+seriesCode;
		        }else{
		          var  url= '${pageContext.request.contextPath}/vod/tv/vodalbuminfo/updatevideo/'+id;
		        }
			       t.domain('edit', {
		             title: '编辑',
		             url: url,
