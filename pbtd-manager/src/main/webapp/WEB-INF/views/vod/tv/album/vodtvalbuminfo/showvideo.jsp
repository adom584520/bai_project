...
<div data-options="region:'center',border:false" style="padding:0px;">
			<br/><br/><br/>
			<table width="98%" cellspacing="1" cellpadding="3" class="tblMain" align="center" style="table-layout:fixed;">
			<tr>
		...
		<td class="tdContent" colspan="2" rowspan="5" style="text-align: right;">
		 ...
		 剧集标题
				...
				<td class="tdContent" style="word-wrap:break-word;" style="word-wrap:break-word;">
			 ${map.title} 	
			</td>
			</tr>
			<tr>
