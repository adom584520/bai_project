        ...
        <script type="text/javascript"> 
            function getinfo() {
                ...
                if(typeof($.data(t[0], 'datagrid')) == 'undefined') {
                	...
                	t.domain('datagrid', {
                        title: '付费包绑定',
                    	url: '${pageContext.request.contextPath}/vod/vodCollectfeesbag/albuminfo/phonepage',
        	...
        	//绑定付费包
       	 	var  sysBtn=$.extend($.fn.domain.Btnsys,{
                   title:"绑定",
  	     	       ...
  	     	       $.ajax({
  	                   url:"${pageContext.request.contextPath}/vod/phone/vodalbuminfo/updateCollectfeesbag",
  	                   type:"POST",
  	                   dataType:"JSON",
