...
<div data-options="region:'center',border:false" style="padding:0px;">
    <form id="vodCorner"  accept-charset="utf-8" style="margin:10px; padding:0; visibility:hidden" method="post" autoTypeset="false" columnSize="2">
	<input type="hidden" id="id" name="id" />
		...
		描述
				...
				<td class="tdContent">
				<input type="text" id="bz"name="bz"        style="" data-options="validType:'text[1,200]',required:true" />
				</td>
			</tr>
			 <tr>
		...
		角标位置
				...
				<td class="tdContent">
				<select id="pos" name="pos" style="width: 120px;" class="chzn-select">
						<option value="1">上左 </option>
						<option value="2">上右 </option>
						<option value="3">中左 </option>
						<option value="4">中右 </option>
						<option value="5">下左 </option>
...
<script type="text/javascript">
	//页面初始化
   	$(function(){
	        ...
	        //加载数据
	        t.domain('load', {
	            url: '${pageContext.request.contextPath}/vod/vodCorner/load/' + id,
	            names: [],
	    ...
	    var  url= '${pageContext.request.contextPath}/vod/vodCorner/'+($.query.getId()=="0"?'create':'edit/'+id);  
		     t.domain('edit', {
	             title: ' ',
	             url: url,
	             data: data,
