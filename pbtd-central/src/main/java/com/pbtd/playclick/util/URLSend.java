...
public class URLSend {
	...
	public static void main(String[] args) {
        try {
        	//SP代码$用户手机号$业务代码$定购时间
        	Des3 des3 = new Des3(); 
        	byte[] key="120140227715929081188500".getBytes("UTF-8");
        	byte[] src = "10655911$13032834193$DG$2014-02-28 09:30:00".getBytes("UTF-8");
        	String encryptData = new BASE64Encoder().encode( des3.des3EncodeECB(key, src) );
    		...
    		System.out.println( sendGet("http://119.6.251.137:7002/subscription/serviceredir.aspx", 
    				"SpNumber=10655911&AccessTime="+time+"&EncodeStr="+encryptData));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }*/
