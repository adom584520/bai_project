...
public class NavigationServiceImpl implements NavigationService {
	...
	public void delete(Long id) {
		...
		navIds.add(id);
		opTemplateService.updateDataStatus(navIds, LauncherConstant.LAUNCHER_DATA_STATUS_INVALID);
	}
	...
	public void deleteBatch(List<Long> ids) {
		...
		opTemplateService.updateDataStatus(ids, LauncherConstant.LAUNCHER_DATA_STATUS_INVALID);
	}

	@Override
	@Transactional
	public void updateDataStatus(List<Long> list, Integer dataStatus) {
		navigationMapper.updateDataStatus(list,dataStatus);
		opTemplateService.updateDataStatusByGroupId(list, dataStatus);
	}
}