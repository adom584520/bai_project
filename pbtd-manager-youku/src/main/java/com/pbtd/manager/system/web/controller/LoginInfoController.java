...
public class LoginInfoController {
	...
	@RequestMapping("/external/insert")
	@ResponseBody
	public ResultBean<LoginInfo> insertExternal(LoginInfo loginInfo) {
		ResultBean<LoginInfo> json = new ResultBean<LoginInfo>();
		try {
			loginInfoService.insertExternal(loginInfo);
			json.setMessage("添加成功！");
		} catch (JsonMessageException e) {
			json.setSuccess(false);
			json.setMessage(e.getMessage());
			logger.warn("系统管理-账号管理-中心分发新增操作-"+e.getMessage());
		} catch (Exception e) {
			json.setSuccess(false);
			json.setMessage("系统出错，请联系管理员！");
			logger.error("系统管理-账号管理-中心分发新增操作-"+e.getMessage(),e);
		}
		return json;
	}
	@RequestMapping("/external/updateLoginInfo")
	@ResponseBody
	public ResultBean<LoginInfo> updateLoginInfoExternal(String target,LoginInfo loginInfo) {
		ResultBean<LoginInfo> json = new ResultBean<LoginInfo>();
		try {
			loginInfoService.updateExternal(target,loginInfo);
			json.setMessage("修改成功！");
		} catch (JsonMessageException e) {
			json.setSuccess(false);
			json.setMessage(e.getMessage());
			logger.warn("系统管理-账号管理-中心分发修改操作-"+e.getMessage());
		} catch (Exception e) {
			json.setSuccess(false);
			json.setMessage("系统出错，请联系管理员！");
			logger.error("系统管理-账号管理-中心分发修改操作-"+e.getMessage(),e);
		}
		return json;
	}
	@RequestMapping("/external/deleteLoginInfo")
	@ResponseBody
	public ResultBean<LoginInfo> deleteLoginInfo(String username) {
		ResultBean<LoginInfo> json = new ResultBean<LoginInfo>();
		try {
			loginInfoService.deleteExternal(username);
			json.setMessage("删除成功！");
		} catch (JsonMessageException e) {
			json.setSuccess(false);
			json.setMessage(e.getMessage());
			logger.warn("系统管理-账号管理-中心分发删除操作-"+e.getMessage());
		} catch (Exception e) {
			json.setSuccess(false);
			json.setMessage("系统出错，请联系管理员！");
			logger.error("系统管理-账号管理-中心分发删除操作-"+e.getMessage(),e);
		}
		return json;
	}
	@RequestMapping("/external/resetPassword")
	@ResponseBody
	public ResultBean<LoginInfo> resetPasswordExternal(String username) {
		ResultBean<LoginInfo> json = new ResultBean<LoginInfo>();
		try {
			loginInfoService.resetPasswordExternal(username);
			json.setMessage("修改成功！");
		} catch (JsonMessageException e) {
			json.setSuccess(false);
			json.setMessage(e.getMessage());
			logger.warn("系统管理-账号管理-中心分发重置密码操作-"+e.getMessage());
		} catch (Exception e) {
			json.setSuccess(false);
			json.setMessage("系统出错，请联系管理员！");
			logger.error("系统管理-账号管理-中心分发重置密码操作-"+e.getMessage(),e);
		}
		return json;
	}
	@RequestMapping("/external/updateSelfInfo")
	@ResponseBody
	public ResultBean<LoginInfo> updateSelfInfoExternal(LoginInfo loginInfo) {
		ResultBean<LoginInfo> json = new ResultBean<LoginInfo>();
		try {
			loginInfoService.updateSelfInfoExternal(loginInfo);
			json.setMessage("修改成功！");
		} catch (JsonMessageException e) {
			json.setSuccess(false);
			json.setMessage(e.getMessage());
			logger.warn("系统管理-账号管理-中心分发修改个人资料操作-"+e.getMessage());
		} catch (Exception e) {
			json.setSuccess(false);
			json.setMessage("系统出错，请联系管理员！");
			logger.error("系统管理-账号管理-中心分发修改个人资料操作-"+e.getMessage(),e);
		}
		return json;
	}
	@RequestMapping("/external/updatePassword")
	@ResponseBody
	public ResultBean<LoginInfo> updatePasswordExternal(String username,String password) {
		ResultBean<LoginInfo> json = new ResultBean<LoginInfo>();
		try {
			loginInfoService.updatePasswordExternal(username,password);
			json.setMessage("修改成功！");
		} catch (JsonMessageException e) {
			json.setSuccess(false);
			json.setMessage(e.getMessage());
			logger.warn("系统管理-账号管理-中心分发修改个人密码操作-"+e.getMessage());
		} catch (Exception e) {
			json.setSuccess(false);
			json.setMessage("系统出错，请联系管理员！");
			logger.error("系统管理-账号管理-中心分发修改个人密码操作-"+e.getMessage(),e);
		}
		return json;
	}
	@RequestMapping("/external/updateStatus")
	@ResponseBody
	public ResultBean<LoginInfo> updateStatusExternal(String username,Integer status) {
		ResultBean<LoginInfo> json = new ResultBean<LoginInfo>();
		try {
			loginInfoService.updateStatusExternal(username,status);
			json.setMessage("修改成功！");
		} catch (JsonMessageException e) {
			json.setSuccess(false);
			json.setMessage(e.getMessage());
