package com.pbtd.manager.vod.tv.special.mapper;
...
@Mapper
public interface VodTvSpecialMapper  {
     ...
     * @return 记录列表
     */
    List<VodTvSpecial> page(int start, int limit, Map<String, Object> queryParams);
    ...
    int insertjson(VodTvSpecial vodSpecial);
    /**
     * 修改记录
     */
