        ...
        <script type="text/javascript"> 
            function getinfo() {
                ...
                if(typeof($.data(t[0], 'datagrid')) == 'undefined') {
                	...
                	var customToolbar = [$.fn.domain.create,'-',$.fn.domain.edit,'-',sys1Btn];
                	t.domain('datagrid', {
                        title: '剧集信息',
                    	url: '${pageContext.request.contextPath}/vod/tv/vodalbuminfo/videopage/'+id,
                        ...
                        columns: [[
	                    	...
	                    	,{field: 'hwversionlist', title: '码率', width: 80,  align: 'center', hidden: false}
	                    	,{field: 'hwversion', title: '已注入码率', width: 80,  align: 'center', hidden: false}
        	...
        	$.fn.domain.create={
        	        ...
        	        disabled: false,
        	        handler: function() {
        	            var url ="${pageContext.request.contextPath}/vod/tv/vodalbuminfo/video/edit/"+$.query.getId()+"/-1";
        	...
        	$.fn.domain.edit={
        	        ...
        	        handler: function() {   
        		        ...
        		        var code=nodes[0].id;
        	            var url ="${pageContext.request.contextPath}/vod/tv/vodalbuminfo/video/edit/"+$.query.getId()+"/"+code;
        	            $(parent).domain("openDialog", { 
        	            	iconCls: "icon-edit", 
        	            	title: "编辑 ", 
        	            	src: url, 
	        	 ...
	        	 function deletes(ids,type){
	        		 var  url= '${pageContext.request.contextPath}/vod/tv/vodalbuminfo/video/deletes';	  	 
		  			 $.ajax({
		               	url:url,
		               	type:"POST",
		               	data:{'id':ids},
