...
public class VodAlbuminfoService implements IVodAlbuminfoService {
	...
	@Override
	public List<Vodalbuminfo> page(Map<String, Object> queryParams) {
	
		return vodAlbuminfoMapper.page(queryParams);
	}
    ...
    */
	...
	public List<Map<String, Object>> pageAlbumsinfovideo(Map<String, Object> queryParams) {		
		return vodAlbuminfoMapper.pageAlbumsinfovideo(queryParams);
	}
   /**
    * 节目批量上下线
    */
   @Override
	...
	return vodAlbuminfoMapper.updatestatus(queryParams);
}

@Override
public List<Map<String, Object>> recommandalbum(Map<String, Object> queryParams) {
	return vodAlbuminfoMapper.recommandalbum(queryParams);
}
...
public int updateisshow(Map<String, Object> map) {
	return vodAlbuminfoMapper.updateisshow(map);
}
