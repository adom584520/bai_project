			   ...
			   // ckButton += "&nbsp;&nbsp;&nbsp;<button  onclick='editvideo(\""+row.id+"\")' class='easyui-linkbutton'>编辑剧集</button>";
	        	...
	        	function showPriorityDialog(id,type){
	        		$(parent).domain("openDialog",{
	        			iconCls:'icon-view',
	        			title:'设置优先级',
	        			src:"${pageContext.request.contextPath}/inject/injectPhoneFail/showVideoPriority?id="+id+"&type="+type,
	        			width:400,
	        			height:200,
	        			onClose:function(){
	        				getalbumin();
	        	...
	        	function sendInject(id,vodId,type){
	        		$.ajax({
	        			type:'post',
	        			url:'${pageContext.request.contextPath}/inject/injectPhoneFail/SendOutAlbumVideo',
	        			data:{
	        				id:id,
	        				vodId:vodId,
	        				type:type
