        ...
        <script type="text/javascript"> 
            function getalbumin() {
                ...
                if(typeof($.data(t[0], 'datagrid')) == 'undefined') {
                	...
                	t.domain('datagrid', {
                        title: 'phone节目管理',
                    	url: '${pageContext.request.contextPath}/inject/injectPhoneZx/videopage/'+seriesCode,
        	...
        	function showOperate(value,row,index){
	        	...
	        	function sendInject(vodId){
	        		$.ajax({
	        			type:'post',
	        			url:'${pageContext.request.contextPath}/inject/injectPhoneZx/SendOutAlbumVideo',
	        			data:{
	        				vodId:vodId
	        			},
	        			dataType:'json',
