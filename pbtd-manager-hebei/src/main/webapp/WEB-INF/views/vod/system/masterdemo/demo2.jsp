...
<html>
	...
	<body>
		<div id="moban">
			<div class="box1">
	        	    <div class="top">
	        	    	   <div class="list" style="width: 485px;" data-id="${curid}" onclick="changeUrl(this,1)">点击编辑</div>
	        	    	   <div class="list" style="margin-left: 30px;width: 485px;" data-id="${curid}" onclick="changeUrl(this,2)">点击编辑</div>
	        	    </div>
	        	    <div class="bottom">
	        	    	   ...
	        	    	   <div class="list" data-id="${curid}" onclick="changeUrl(this,6)">点击编辑</div>
	        	    	   <div class="list" data-id="${curid}" onclick="changeUrl(this,7)">点击编辑</div>
	        	    	   <div class="list" data-id="${curid}" onclick="changeUrl(this,8)">点击编辑</div>
	        	    </div>
	        </div>
