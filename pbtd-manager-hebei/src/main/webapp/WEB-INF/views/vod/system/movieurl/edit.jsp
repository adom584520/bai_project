...
<div data-options="region:'center',border:false" style="padding:0px;">
    <form id="movieurl"  accept-charset="utf-8" style="margin:10px; padding:0; visibility:hidden" method="post" autoTypeset="false" columnSize="2">
	<input type="hidden" id="id" name="id" />
		...
		<tr>
				  <td style="text-align: right; width: 20%"   style="width: 120px;" class="tdCaption"  align="center">
					...
					<td class="tdContent"> 
					<input type="text" id="title" name="title"  class="easyui-validatebox" validType="text[1,20]" required="true">
				 </td>
				</tr>
				<tr>
				 	<td style="text-align: right; width: 20%"   style="width: 120px;" class="tdCaption"  align="center">
					...
					<option value="zxmovieurl">源播放地址</option>
					<option value="zxfileurl">源文件地址</option>
					<option value="zxdispatchurl">中兴调度地址</option>
					<option value="hwdispatchurl">华为调度地址</option>
					</select>
					 </td>
				</tr>
				<tr>
				<td style="text-align: right; width: 20%"   style="width: 120px;" class="tdCaption"  align="center">
					...
					<td class="tdContent"> 
					<select id="levels" name="levels"  style="width: 120px;" >
...
<script type="text/javascript">
	//页面初始化
   	$(function(){
	        ...
	        //加载数据
	        t.domain('load', {
	            url: '${pageContext.request.contextPath}/vod/system/vodmovie/load/' + id,
	            names: [],
	    ...
	    var  url= '${pageContext.request.contextPath}/vod/system/vodmovie/'+($.query.getId()=="0"?'create':'edit/'+id);  
		     t.domain('edit', {
	             title: ' ',
	             url: url,
	             data: data,
