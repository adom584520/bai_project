...
public interface OperationPositionMapper {
	 ...
	 * @param modifyTime
	 */
	void updateStatusByNavId(@Param("navId")Long navId, @Param("status")Integer status,@Param("modifyTime")Date modifyTime);
	 ...
	 * @param dataType
	 */
	void updateDataStatusByNavId(@Param("list")List<Long> list,@Param("dataStatus")Integer dataStatus);
}
