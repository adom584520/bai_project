        ...
        <script type="text/javascript"> 
            function getalbuminfor() {
                ...
                if(typeof($.data(t[0], 'datagrid')) == 'undefined') {
                	...
                	t.domain('datagrid', {
                        title: '绑定数据',
                    	url: '${pageContext.request.contextPath}/vod/tv/vodalbuminfo/albuminfopage/'+id,
	                    ...
	                    title:"添加节目",
	               		...
	               		handler: function() {   
	               			$(parent).domain("openDialog", { 
	    	     	        	iconCls: "icon-view", 
	    	     	        	title: "添加", 
	    	     	        	src: "${pageContext.request.contextPath}/vod/tv/vodalbuminfo/addalbuminfor/${id}",
	    	     	        	width: 1250,
	    	    	        	height: 650,
	    	     	        	onClose: function() { 
	    	     	        		var ids = top.$.data(top.document.body, "choose.ids");
	    	   	               	 $.ajax({
	    	   	               	     		url:"${pageContext.request.contextPath}/vod/tv/vodalbuminfo/addalbumrecommand",
	    	   	               	     		type:"post",
	               		...
	               		handler: function() {
	               	 	...
	               	 	$.messager.confirm('确认','确认删除？',function(r){
	               	 		if(r==false){return false;}
	    	     	        		$.ajax({
	    	                           	url:"${pageContext.request.contextPath}/vod/tv/vodalbuminfo/deletealbumrecommand",
	    	                           	type:"GET",
	    	                           	dataType:"JSON",
	        				...
	        				nodes = $table.datagrid("getChanges");
	               	        ...
	               	        for (var i = 0; i < nodes.length; i++) {
	            	            ...
	            	            sequence+=","+nodes[i]["sequence"];
	    	     	        		...
	    	     	        		$.ajax({
	    	                           	url:"${pageContext.request.contextPath}/vod/tv/vodalbuminfo/updatealbumrecommand",
	    	                           	type:"GET",
	    	                           	dataType:"JSON",
