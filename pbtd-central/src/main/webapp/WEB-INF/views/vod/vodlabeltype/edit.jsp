...
<div data-options="region:'center',border:false" style="padding:0px;">
    <form id="vodlabeltype"  accept-charset="utf-8" style="margin:10px; padding:0; visibility:hidden" method="post" autoTypeset="false" columnSize="2">
	<input type="hidden" id="id" name="id" />
		...
		数字前缀
				...
				<td class="tdContent">
		<input type="text" id="num" name="num" class="easyui-numberbox"   style="width: 60px" data-options="min:1,max:999,required:true" />	
	</td>
			</tr>
			</table>
    </form>
...
<script type="text/javascript">
	//页面初始化
   	$(function(){
	        ...
	        //加载数据
	        t.domain('load', {
	            url: '${pageContext.request.contextPath}/integrate/vodlabeltype/load/' + id,
	            names: [],
	    ...
	    var  url= '${pageContext.request.contextPath}/integrate/vodlabeltype/'+($.query.getId()=="0"?'create':'edit/'+id);  
		     t.domain('edit', {
	             title: ' ',
	             url: url,
	             data: data,
