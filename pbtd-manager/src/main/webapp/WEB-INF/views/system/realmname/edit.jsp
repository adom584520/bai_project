...
<body class="easyui-layout" style="visibility: hidden">
	...
	<div data-options="region:'center',border:false" style="padding: 0px;">
		<form id="vodSpecial" accept-charset="utf-8"
			...
			<table width="98%" cellspacing="1" cellpadding="3" class="tblMain"
				align="center">
				<tr>
					<td style="text-align: right; width: 20%" style="width: 120px;"
						class="tdCaption" align="center">说明</td>
					<td class="tdContent"><input type="text" id="name" name="name"
						class="input text easyui-validatebox-disable" style=""
						data-options="validType:'text[1,30]',required:true" /></td>
				</tr>
				<tr>
					<td style="text-align: right; width: 20%" style="width: 120px;"
						class="tdCaption" align="center">类型</td>
		...
		初始域名
				...
				<td class="tdContent">
				<input type="text" id="oldtitle"name="oldtitle" class="input text easyui-validatebox-disable"       style="" data-options="validType:'text[1,130]',required:true" />
				</td>
			</tr> -->
				<tr>
					<td style="text-align: right; width: 20%" style="width: 120px;"
						class="tdCaption" align="center">域名</td>
					<td class="tdContent"><input type="text" id="newtitle"
						name="newtitle" class="input text easyui-validatebox-disable"
						style="" data-options="validType:'text[1,130]',required:true" />
					</td>
				</tr>
			</table>
		</form>
	...
	//页面初始化
   	$(function(){
	        ...
	        //加载数据
	        t.domain('load', {
	            url: '${pageContext.request.contextPath}/system/realmname/load/' + id,
	            names: [],
	    ...
	    var  url= '${pageContext.request.contextPath}/system/realmname/'+($.query.getId()=="0"?'create':'edit/'+id);  
		     t.domain('edit', {
	             title: ' ',
	             url: url,
	             data: data,
