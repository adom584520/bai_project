...
public class VodTvLabelService implements IVodTvLabelService {
	...
	@Override
	public List<VodTvlabel> page(int start, int limit, Map<String, Object> queryParams) {
		
		return vodTvLabelMapper.page(start, limit, queryParams);
	}
	...
	@Override
	public int insertjson(VodTvlabel vodlabel) {
		return vodTvLabelMapper.insertjson(vodlabel);
	}
