...
<body class="easyui-layout" style="visibility: hidden">
	...
	<div data-options="region:'center',border:false" style="padding: 0px;">
							...
							<tr align="center">
								<td align="center" style="width: 14%;">
									<div class="aixuexi" style="height: 150px;">
										<img id="pictureurl1" class="pictureurl1"
											style="margin-right: 2px;" src="" />
									</div>
									<p>小图竖图</p> <a class='easyui-linkbutton' id="pic1">上传</a>
								</td>
								<td style="width: 14%;" align="center">
									<div class="aixue" style="height: 150px;">
										<img id="pictureurl2" class="pictureurl2"
											style="margin-right: 2px;" src="" />
									</div>
									<p>小图横图</p> <a class='easyui-linkbutton' id="pic2">上传</a>
								</td>
								<td style="width: 14%;" align="center">
									<div class="aixuexi" style="height: 150px;">
										<img id="pictureurl3" class="pictureurl3"
											style="margin-right: 2px;" src="" />
									</div>
									<p>大图竖图</p> <a class='easyui-linkbutton' id="pic3">上传</a>
								</td>
								<td style="width: 14%;" align="center">
									<div class="aixue" style="height: 150px;">
										<img id="pictureurl4" class="pictureurl4" src="" />
									</div>
									<p>大图横图</p> <a class='easyui-linkbutton' id="pic4">上传</a>
								</td>
								
								<td style="width: 14%;" align="center">
									<div class="aixuexi" style="height: 150px;">
										<img id="pictureurl5" class="pictureurl5"
											style="margin-right: 2px;" src="" />
									</div>
									<p>tv小图竖图</p> <a class='easyui-linkbutton' id="pic5">上传</a>
								</td>
								<td style="width: 14%;" align="center">
									<div class="aixue" style="height: 150px;">
										<img id="pictureurl6" class="pictureurl6" src="" />
									</div>
									<p>tv小图横图</p> <a class='easyui-linkbutton' id="pic6">上传</a>
								</td>
								
								<td style="width: 14%;" align="center">
									<div class="aixuexi" style="height: 150px;">
										<img id="pictureurl7" class="pictureurl7"
											style="margin-right: 2px;" src="" />
									</div>
									<p>tv前景图</p> <a class='easyui-linkbutton' id="pic7">上传</a>
								</td>
							</tr>
						</table>
					</td>
		...
		<input type="text" id="seriesCode" name="seriesCode" <c:if test="${seriesCode ne '' }">disabled="disabled"</c:if>  class="input text easyui-validatebox-disable" style="" data-options="validType:'text[1,50]',required:true" />	
	</td>
	<!-- <td style="text-align: right; width: 15%"  class="tdCaption"  align="center">
		 排序
				</td>
	...
	<tr>
		...
		<input type="text" id="seriesName" name="seriesName" class="input text easyui-validatebox-disable" style="" data-options="validType:'text[1,127]',required:true" />	
		 ...
		 专辑原名称
				...
				<td class="tdContent">
		<input type="text" id="originalName" name="originalName" class="input text easyui-validatebox-disable" style="" data-options="validType:'text[1,127]'" />	
	</td>
		...
		<input type="text" id="volumncount" name="volumncount"  class="easyui-numberbox" style="" data-options="validType:'text[1,5]',required:true" />	
		 ...
		 更新剧集
				...
				<td class="tdContent">
		<input type="text" id="currentnum" name="currentnum"  class="easyui-numberbox" style="" data-options="validType:'text[1,50]',required:true" />	
	</td>
			</tr>
	...
	<td  style="text-align: right; width: 15%"  class="tdCaption"  align="center">
		...
		<input type="text" id="actorName" name="actorName" disabled="disabled" class="input text easyui-validatebox-disable" style="" data-options="validType:'text[1,100]',required:true" />
		...
		<input type="text" id="writerName" name="writerName"  disabled="disabled" class="input text easyui-validatebox-disable" style="" data-options="validType:'text[1,500]',required:true" />	
	       ...
	       //解析页面
	        ...
	        t.domain('load', {
	         ...
	         /*    	$channelids2= data.channel2;
	              ...
	              //更改图片按钮
	    	        $("#pic1").linkbutton('enable')[0].onclick=function(){upload(id,1);};
	    	        $("#pic2").linkbutton('enable')[0].onclick=function(){upload(id,2);};
	    	        $("#pic3").linkbutton('enable')[0].onclick=function(){upload(id,3);};
	    	        $("#pic4").linkbutton('enable')[0].onclick=function(){upload(id,4);};
	    	        $("#pic5").linkbutton('enable')[0].onclick=function(){upload(id,5);};
	    	        $("#pic6").linkbutton('enable')[0].onclick=function(){upload(id,6);};
	    	        $("#pic7").linkbutton('enable')[0].onclick=function(){upload(id,7);};
	                ...
	                $("#pictureurl5").attr("src",imgtitle+data.pictureurl5);
	                $("#pictureurl6").attr("src",imgtitle+data.pictureurl6);
	                $("#pictureurl7").attr("src",imgtitle+data.pictureurl7);
	        ...
	        var  url= '${pageContext.request.contextPath}/vod/phone/vodalbuminfo/'+(id=="0"?'create':'edit/'+id);  
	    	     t.domain('edit', {
	                 title: ' ',
	                 url: url,
	                 data: data,
	...
	//演员 导演选择
	 	 function showactors(code){
	         		$(parent).domain("openDialog", { 
	     	        	iconCls: "icon-view", 
	     	        	title: "查看", 
	     	        	src: "${pageContext.request.contextPath}/vod/phone/vodalbuminfo/actorslist",
	     	        	width: 1060, 
	    	        	height: 550,
	     	        	onClose: function() { 
	...
	function reset(type){
		if(type=='actor'){
	 	...
	 	//付费包
			...
			//上传图片
			function upload(id,imgtype){
		        		var picname="phonealbumpic";
		         		$(parent).domain("openDialog", { 
		     	        	iconCls: "icon-view", 
		     	        	title: "上传", 
		     	        	src: "${pageContext.request.contextPath}/uploadPic/updateimg?picname="+picname+"&id="+id+"&imgtype="+imgtype,
		     	        	width: 450, 
		    	        	height: 250,
		    	        	success:function(data){
		    	        		$("#VodAlbuminfo").datagrid("load",{});         
		    	        	},
		     	        	onClose: function() { 
		     	        		$("#VodAlbuminfo").datagrid("load",{});         
		     	            }
