      ...
      <div data-options="region:'north',border:false,split:true" style="padding:0px; border-bottom:1px solid #99BBE8; height:38px; width:auto;">
        ...
        <script type="text/javascript"> 
                ...
                //	var customToolbar = [$.fn.domain.create,'-',$.fn.domain.edit,'-',$.fn.domain.del,'-',saveBtn,'-',savestatusstartBtn,'-',savestatusendBtn];
                	...
                	t.domain('datagrid', {
                        ...
                        columns: [[
                             ...
                             ,{field: 'text', title: '文字', width: 100, sortable: true, align: 'center', hidden: false}
                             ,{field: 'channelCode', title: '频道id', width: 100, sortable: true, align: 'center', hidden: false}
                             ,{field: 'seriesCode', title: '专辑id', width: 100, sortable: true, align: 'center', hidden: false}
                             ,{field: 'seriesName', title: '专辑名称', width: 100, sortable: true, align: 'center', hidden: false}
        	...
        	var sysBtnreset=$.extend($.fn.domain.reset,{
        		...
        		handler:function(){
        			$.ajax({
                      	url:"${pageContext.request.contextPath}/phonereset/resettextrecommendation",
                      	type:"GET",
                      	dataType:"JSON",
                      	data:{},
                      	async:false,
