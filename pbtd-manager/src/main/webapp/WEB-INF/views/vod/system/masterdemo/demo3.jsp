...
<html>
	...
	<body>
		<div id="moban">
			<div class="box1">
	        	    <div class="top">
	        	    	   <div class="list" style="width: 310px;" type="${type}"  data-id="${curid}" onclick="changeUrl(this,1)">点击编辑</div>
	        	    	   <div class="list" style="margin-left: 30px;width: 310px;"  type="${type}"  data-id="${curid}" onclick="changeUrl(this,2)">点击编辑</div>
	        	    	   <div class="list" style="margin-left: 30px;width: 310px;"  type="${type}"  data-id="${curid}" onclick="changeUrl(this,3)">点击编辑</div>
	        	    </div>
	        	    <div class="bottom">
	        	    	   <div class="list" style="margin-left: 0;"  type="${type}"  data-id="${curid}" onclick="changeUrl(this,4)">点击编辑</div>
	        	    	   <div class="list"  type="${type}"  data-id="${curid}" onclick="changeUrl(this,5)">点击编辑</div>
	        	    	   <div class="list"  type="${type}"  data-id="${curid}" onclick="changeUrl(this,6)">点击编辑</div>
	        	    	   <div class="list"  type="${type}"  data-id="${curid}" onclick="changeUrl(this,7)">点击编辑</div>
	        	    	   <div class="list"  type="${type}"  data-id="${curid}" onclick="changeUrl(this,8)">点击编辑</div>
	        	    	   <div class="list"  type="${type}"  data-id="${curid}" onclick="changeUrl(this,9)">点击编辑</div>
	        	    </div>
	        </div>
		...
		function changeUrl(obj,num){
		  ...
		  $(parent).domain("openDialog", { 
  	        	iconCls: "icon-view", 
  	        	title: "绑定",
  	        	src: "${pageContext.request.contextPath}/vod/"+type+"/vodmouldinfo/getalbum/"+pid+"/"+num,
  	        	width: 1250,
 	        	height: 650,
  	        	onClose: function() {
