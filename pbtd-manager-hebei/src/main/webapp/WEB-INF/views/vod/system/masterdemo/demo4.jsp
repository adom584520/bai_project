...
<html>
	...
	<body>
		<div id="moban">
			<div class="box3">
	        	    <div class="left">
	        	    	   <div class="list" style="width: 300px;height: 340px;line-height: 340px;" data-id="${curid}" onclick="changeUrl(this,1)">点击编辑</div>
	        	    </div>
	        	    <div class="right">
	        	    	   <div class="list" style="margin-left: 0;" data-id="${curid}" onclick="changeUrl(this,2)">点击编辑</div>
	        	    	   ...
	        	    	   <div class="list" style="margin-left: 0;margin-top: 20px;" data-id="${curid}" onclick="changeUrl(this,6)">点击编辑</div>
	        	    	   <div class="list" style="margin-top: 20px;" data-id="${curid}" onclick="changeUrl(this,7)">点击编辑</div>
	        	    	   <div class="list" style="margin-top: 20px;" data-id="${curid}" onclick="changeUrl(this,8)">点击编辑</div>
	        	    	   <div class="list" style="margin-top: 20px;" data-id="${curid}" onclick="changeUrl(this,9)">点击编辑</div>
	        	    </div>
	        </div>
	        
	         <div style="clear:both;width:120px;height:100px;margin-left:640px;margin-top:30px;">
