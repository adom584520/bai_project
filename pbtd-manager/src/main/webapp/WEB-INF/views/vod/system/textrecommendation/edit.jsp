...
<div data-options="region:'center',border:false" style="padding:0px;">
    <form id="textrecommendationMapper"  accept-charset="utf-8" style="margin:10px; padding:0; visibility:hidden" method="post" autoTypeset="false" columnSize="2">
			...
			<table width="98%" cellspacing="1" cellpadding="3" class="tblMain" align="center">
				<tr>
				  <td style="text-align: right; width: 20%"   style="width: 120px;" class="tdCaption"  align="center">
					...
					<td class="tdContent"> 
					<input type="text" id="text" name="text"   class="easyui-validatebox" validType="text[1,50]">
				 </td>
				</tr>
				<tr>
				 	<td style="text-align: right; width: 20%"   style="width: 120px;" class="tdCaption"  align="center">
				...
				<td style="text-align: right; width: 20%"   style="width: 120px;" class="tdCaption"  align="center">
					...
					<td class="tdContent"> 
					 <select  id="channelCode" name="channelCode"  style="width: 120px;">
				...
				<tr>
				  <td style="text-align: right; width: 20%"   style="width: 120px;" class="tdCaption"  align="center">
					...
					<td class="tdContent"> 
					<input type="text" id="seriesCode" name="seriesCode"   class="easyui-validatebox" validType="text[1,50]" required="true" missingMessage="请输入">
				 </td>
				</tr>
				<tr>
				  <td style="text-align: right; width: 20%"   style="width: 120px;" class="tdCaption"  align="center">
					...
					<td class="tdContent"> 
					<input type="text" id="seriesName" name="seriesName"   class="easyui-validatebox" validType='text[1,50]' required="true" missingMessage="请输入，必须为文字">
				 </td>
				</tr>
				<tr>
				  <td style="text-align: right; width: 20%"   style="width: 120px;" class="tdCaption"  align="center">
				...
				<tr>
				  <td style="text-align: right; width: 20%"   style="width: 120px;" class="tdCaption"  align="center">
					...
					<td class="tdContent"> 
					<input type="text" id="textPic" name="textPic"   class="easyui-validatebox" validType='text[1,100]'>
				 </td>
				</tr>
				<tr>
				  <td style="text-align: right; width: 20%"   style="width: 120px;" class="tdCaption"  align="center">
					...
					<td class="tdContent"> 
					<select id="picStatus" name="picStatus"  style="width: 120px;" class="status-select">
						<option value="0">展示图片</option>						
						<option value="1">不展示图片</option>
					</select>
				 </td>
				</tr>
				<tr>
...
<script type="text/javascript">
	//页面初始化
   	$(function(){
	        ...
	        var t = $('#textrecommendationMapper');
	        //加载数据
	        t.domain('load', {
	            url: '${pageContext.request.contextPath}/vod/system/textrecommendation/load/'+id,
	            names: [],
	    ...
	    var  url= '${pageContext.request.contextPath}/vod/system/textrecommendation/'+($.query.getId()=="0"?'create':'edit/'+id);  
		     t.domain('edit', {
	             title: ' ',
	             url: url,
	             data: data,
