...
<html>
    ...
    <body class="easyui-layout" style="visibility:hidden">
      <div data-options="region:'north',border:false,split:true" style="padding:0px; border-bottom:1px solid #99BBE8; height:3px; width:auto;">
        ...
        <script type="text/javascript"> 
            function getvodactors() {
                ...
                if(typeof($.data(t[0], 'datagrid')) == 'undefined') {
                	...
                	var customToolbar = [$.fn.domain.del,'-',sysBtns5];
                	t.domain('datagrid', {
                        title: '标签管理',
                    	url: '${pageContext.request.contextPath}/vod/phone/VodLabeltype/page',
            ...
            title:"同步",
       		...
       		handler: function() {
       	      	$.ajax({
                      	url:"${pageContext.request.contextPath}/phonereset/phonelabeltype",
                      	type:"GET",
                      	dataType:"JSON",
                      	data:{},
                      	async:false,
