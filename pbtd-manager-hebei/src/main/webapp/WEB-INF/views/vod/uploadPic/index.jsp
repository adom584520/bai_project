...
<body>
	...
	<div data-options="region:'center',border:false" style="padding: 0px;">
		<form id="form" enctype="multipart/form-data"
			style="margin: 30px; padding: 0;" method="post" columnSize="2">
			<input type="hidden" id="id" name="id" />
			<table align="center">
				<tr>
					<td>上传图片 <input id="file" name="file" type="file"
						style="width: 200px"> <a id="uploadbutton"
						href="javascript:startUpload()" class="easyui-linkbutton">上传</a>
					</td>
				</tr>
				<tr>
				<td>
					...
					.form(
							'submit',
							{
								...
								onSubmit : function() {
									var name = $("#file").val();
									if (name != '') {
										var suffix = name.substring(name
												.lastIndexOf("."));
										if (suffix != ".jpg"
												&& suffix != ".JPG"
												&& suffix != ".png"
											...
											alert("只支持jpg(JPG)/png(PNG)/gif(GIF)上传",
													"文件限制");
											return false;
										}
									} else {
								...
								success : function(data) {
									...
									if (data.success) {
										...
										if (picname == "recommandPic") {
											...
											url = '${pageContext.request.contextPath}/vod/vodactors/editimg/'
													+ id;
										} else if (picname == "vodSpecial") {
											url = '${pageContext.request.contextPath}/vod/phone/vodSpecial/editimg/'
													+ id;
										} else if (picname == "vodCorner") {
											url = '${pageContext.request.contextPath}/vod/vodCorner/editimg/'
													+ id;
										} else if (picname == "vodTvSpecial") {
											url = '${pageContext.request.contextPath}/vod/tv/vodSpecial/editimg/'
													+ id;
										...
										} else if (picname == "vodlogopic") {
											url = '${pageContext.request.contextPath}/vod/system/vodlogo/updateLogo';
										}else if(picname=="vodMasterplate"){
											url = '${pageContext.request.contextPath}/vod/Masterplate/updateimg';
										...
										}else if(picname=="yywimgurl1"){
											url = '${pageContext.request.contextPath}/vod/tv/vodmouldinfo/editimg/one';
										}else if(picname=="yywimgurl2"){
											url = '${pageContext.request.contextPath}/vod/tv/vodmouldinfo/editimg/two';
										}else if(picname=="yywimgurl3"){
											url = '${pageContext.request.contextPath}/vod/tv/vodmouldinfo/editimg/three';
										}else if(picname=="yywimgurl4"){
											url = '${pageContext.request.contextPath}/vod/tv/vodmouldinfo/editimg/four';
										}else if(picname=="yywpimgurl1"){
											url = '${pageContext.request.contextPath}/vod/phone/vodmouldinfo/editimg/one';
										}else if(picname=="yywpimgurl2"){
											url = '${pageContext.request.contextPath}/vod/phone/vodmouldinfo/editimg/two';
										}else if(picname=="yywpimgurl3"){
											url = '${pageContext.request.contextPath}/vod/phone/vodmouldinfo/editimg/three';
										}else if(picname=="yywpimgurl4"){
											url = '${pageContext.request.contextPath}/vod/phone/vodmouldinfo/editimg/four';
										}
