                ...
                if(typeof($.data(t[0], 'datagrid')) == 'undefined') {
                	...
                	t.domain('datagrid', {
                        ...
                        columns: [[
										...
										{field: 'type', title: '跳转类型', width: 60, align: 'center', hidden: false,formatter:formatterType},
										{field: 'showType', title: '显示类型', width: 60, align: 'center', hidden: false,formatter:formatterShowType},
										...
										{field: 'skipTime', title: '播放时间', width: 60, align: 'center', hidden: false,formatter:formatterSkipTime},
          	 ...
          	 var  sysBtns5=$.extend($.fn.domain.Btnsys5,{
          		...
          		handler: function() {
          			 ...
          			 if(curtime=="" || curtime==null){
          	      	...
          	      	$.ajax({
                         	url:"${pageContext.request.contextPath}/integrate/outputjson/phone/phonestartshowip",
                         	type:"GET",
                         	dataType:"JSON",
