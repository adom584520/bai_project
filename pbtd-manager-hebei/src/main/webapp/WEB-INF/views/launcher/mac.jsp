...
<script type="text/javascript" src="/js/launcher/mac/mac.js"></script>
<style type="text/css">
</style>
</head>
<body class="easyui-layout">
	<div data-options="region:'north',border:false" style="padding:0px;height: 160px;">
		<div align="center" style=";height: 120px;">
			<form id="groupAddOrEditFrom">
		   		<input id="groupId" name="id" value="${launcherGroup.id}" type="hidden"/>
				<table>
					<tr>
						<td height="32px" align="left">
							分组名称：<input id="group_name" name="groupName" class="easyui-textbox" style="width: 140px;height:25px" value="${launcherGroup.groupName}">
						</td>
						<td height="32px" align="right" >
							联系人：<input id="contacts" name="contacts" class="easyui-textbox" style="width: 140px;height:25px" value="${launcherGroup.contacts}">
						</td>
					</tr>
					<tr>
						<td height="32px" align="left">
							联系号码：<input id="contacts_number" name="contactsNumber" class="easyui-textbox" style="width: 140px;height:25px" value="${launcherGroup.contactsNumber}">
						</td>
						<td height="32px" align="right">
							联系地址：<input id="address" name="address" class="easyui-textbox" style="width: 140px;height:25px" value="${launcherGroup.address}">
						</td>
					</tr>
				</table>
			</form>
	...
	<div id="macAddOrEditDialog">
		<form id="macAOrEditFrom" method="post">
			<input id="macGroupId" name="groupId" value="${launcherGroup.id}" type="hidden"/>
