...
(function($){
	...
	_eventProxy = function(e) {
		...
		if (tools.eqs(e.type, "mouseover")) {
			...
			if(curpid == '' && clitype == "tv" ){
				 var url = "/vod/tv/vodmouldinfo/basePage?channel="+curid+"&channelname="+channelname;
					$("#iframe").attr("src",url); 
			}
			if(curpid == '' && clitype == "phone" ){
				var url = "/vod/phone/vodmouldinfo/basePage?channel="+curid+"&channelname="+channelname;
				$("#iframe").attr("src",url); 
			}
			//TODO
			 try
			   ...
			   //在这里运行代码
				 if(son==1 && curpid!=0 && clitype == "tv"){
					 ...
					 document.getElementById("iframe").contentWindow.childUpDownFunctionPhone(channelname,curpid,cursequence+"");
				 }else{
				 }
			   }
			 catch(err)
