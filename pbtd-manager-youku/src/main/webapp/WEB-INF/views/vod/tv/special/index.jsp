        ...
        <script type="text/javascript"> 
        	...
        	$(function(){
        	 ...
        	 function  getimgurl(e){
     	    	return "<img  style='width:80px;height:40px;'  onclick='showimg(${maprealm.imgtitle}"+e+")'    src=${maprealm.imgtitle}"+e+"  />";
     	    }
    	 ...
    	 //当天更新同步
          	var sysBtnreset=$.extend($.fn.domain.reset,{
          		...
          		handler:function(){
          			$.ajax({
                        	url:"${pageContext.request.contextPath}/tvreset/resetspecial",
                        	type:"GET",
                        	dataType:"JSON",
                        	data:{},
                        	async:false,
          	 ...
          	 //删除
	        	var sysBtndel=$.extend($.fn.domain.del,{
     	    	...
     	    	$(parent).domain("openDialog", { 
     	        	iconCls: "icon-view", 
     	        	title: "图片查看", 
     	        	src: "${pageContext.request.contextPath}/uploadPic/showimg?img="+img,
     	        	width: 650, 
    	        	height: 550,
     	        	onClose: function() { 
