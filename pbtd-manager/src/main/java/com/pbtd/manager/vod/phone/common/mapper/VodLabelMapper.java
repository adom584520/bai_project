...
public interface VodLabelMapper {
     ...
     * @return 记录列表
     */
    List<Vodlabel> page(Map<String, Object> queryParams);
	...
	int insertPrimary(@Param("id")Integer id, @Param("name")String name,
			@Param("channelCode")Integer channelCode, @Param("level")Integer level, @Param("sequence")String sequence);
