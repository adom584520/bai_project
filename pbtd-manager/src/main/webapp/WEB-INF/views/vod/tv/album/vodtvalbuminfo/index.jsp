        ...
        <script type="text/javascript"> 
            function getinfo() {
                ...
                if(typeof($.data(t[0], 'datagrid')) == 'undefined') {
                	...
                	var customToolbar = [$.fn.domain.edit,'-',sysBtn,'-',sysBtns,'-',sysBtnz,'-',sysBtnup,'-',sysBtnno,'-',sysBtns5,'-',sysBtnexport];
                	t.domain('datagrid', {
                        title: 'tv数据管理',
                        ...
                        columns: [[
	                    	...
	                    	,{field: 'status', title: '状态', width: 100,  align: 'center', hidden: false,
	                    		formatter: function(value,rows) { 
	                    			if(value==0){
	                    				var sta="<span style='color:red'>下线</span>"
	                    			}else if(value==1){
	                    				var sta="<span  style='color:green'>上线</span>"
	                    			}
	                                 return sta;     
								}}
	        	 ...
	        	 var  sysBtns5=$.extend($.fn.domain.Btnsys5,{
	        		...
	        		handler: function() {
	        			 ...
	        			 if(curtime=="" || curtime==null){
	        	      	...
	        	      	$.ajax({
	                       	url:"${pageContext.request.contextPath}/integrate/outputjson/tv/tvalbumip",
	                       	type:"GET",
	                       	dataType:"JSON",
