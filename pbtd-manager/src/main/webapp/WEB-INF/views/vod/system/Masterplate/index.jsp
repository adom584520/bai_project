        ...
        <script type="text/javascript"> 
            function getinfo() {
                ...
                if(typeof($.data(t[0], 'datagrid')) == 'undefined') {
                	var customToolbar = ['-',$.fn.domain.edit,'-',sysBtndel,'-',sysBtnSender];
                	t.domain('datagrid', {
                        title: '模板管理',
            ...
            $(function(){
                ...
                if($.fn.domain.defaults.datagrid.auto) getinfo();
       			...
       			//下发
	          	var sysBtnSender=$.extend($.fn.domain.reset,{
	          		title:'下发',
	          		text:'下发',
	          		iconCls:"icon-ok",
	          		handler:function(){
	          			var rows=$('#vodinfo').datagrid('getChecked');
	          			console.log(rows);
	          			if(rows!=null && rows.length==0){
	          				/* $.messager.confirm('请选择需下发的模板',function(r){
	          				}); */
	          				$.messager.alert('提示','请选择需下发的模板','info');
	          				return;
	          			}
	          			var ids="";
	          			...
	          			$.ajax({
	                        	url:"${pageContext.request.contextPath}/integrate/outputjson/tv/tvmoduleip",
	                        	type:"GET",
	                        	dataType:"JSON",
	                        	data:{
