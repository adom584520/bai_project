...
public class StartSlideshowServiceImpl implements StartSlideshowService {
	...
	@Override
	public Long queryCount(StartSlideshowQueryObject qo) {
		return startSlideshowMapper.queryCount(qo);
	}

	@Override
	public List<StartSlideshow> queryListforinterface(StartSlideshowQueryObject qo) {
		return startSlideshowMapper.queryListforinterface(qo);
	}
}
