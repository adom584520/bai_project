	...
	<td  style="text-align: right; width: 15%"  class="tdCaption"  align="center">
		...
		<input type="text" id="actorName" name="actorName" class="input text easyui-validatebox-disable" style="" data-options="validType:'text[1,100]',required:true" />
		 ...
		 演员
				...
				<td class="tdContent" colspan="3">
		 <input  id="writerName" name="writerName" class="input text easyui-validatebox-disable" style="" data-options="validType:'text[1,500]',required:true" />	
	</td>
			</tr>
...
<script type="text/javascript">
    ...
    function show(id){
		$(parent).domain("openDialog", { 
        	iconCls: "icon-view", 
        	title: "查看", 
        	src: "${pageContext.request.contextPath}/vod/tv/vodalbuminfo/showvideo/"+id,
        	width: 760, 
        	height: 450,
        	onClose: function() { 
            }
