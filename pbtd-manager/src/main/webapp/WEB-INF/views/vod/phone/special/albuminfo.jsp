   ...
   a.l-btn span span.l-btn-text {
    ...
    <body class="easyui-layout" style="visibility:hidden">
      <div data-options="region:'north',border:false,split:true" style="padding:0px; border-bottom:1px solid #99BBE8; height:38px; width:auto;">
			...
			<input type="hidden" id="special_id" name="special_id"/>
        ...
        <script type="text/javascript"> 
            function getinfo() {
                ...
                if(typeof($.data(t[0], 'datagrid')) == 'undefined') {
                	...
                	t.domain('datagrid', {
                        title: '绑定数据',
                    	url: '${pageContext.request.contextPath}/vod/phone/vodSpecial/albuminfopage',
	                    ...
	                    title:"添加节目",
	               		...
	               		handler: function() {
	               			$(parent).domain("openDialog", { 
	    	     	        	iconCls: "icon-view", 
	    	     	        	title: "添加", 
	    	     	        	src: "${pageContext.request.contextPath}/vod/phone/vodSpecial/addalbuminfo/"+$tagsids,
	    	     	        	width: 1250, 
	    	    	        	height: 650,
	    	     	        	onClose: function() { 
	    	     	        		var ids = top.$.data(top.document.body, "choose.ids");
	    	     	        		$.ajax({
	    	                           	url:"${pageContext.request.contextPath}/vod/phone/vodSpecial/addalbuminfo",
	    	                           	type:"GET",
	    	                           	dataType:"JSON",
	    	                           	data:{albumid:ids,id:$tagsids},
	    	                           	async:false,
	    	                           	success:function(){
	               	    	...
	               	    	$.messager.confirm('确认','确认删除？',function(r){
	               	    		if(r){
			               	        ...
			               	        for (var i = 0; i < nodes.length; i++) {
		   	     	        		...
		   	     	        		$.ajax({
		   	                           	url:"${pageContext.request.contextPath}/vod/phone/vodSpecial/delalbuminfo",
		   	                           	type:"GET",
		   	                           	dataType:"JSON",
	        				...
	        				nodes = $table.datagrid("getChanges");
	               	        ...
	               	        for (var i = 0; i < nodes.length; i++) {
	            	            ...
	            	            sequence+=","+nodes[i]["sequence"];
	    	     	        		...
	    	     	        		$.ajax({
	    	                           	url:"${pageContext.request.contextPath}/vod/phone/vodSpecial/updatealbumsequence",
	    	                           	type:"GET",
	    	                           	dataType:"JSON",
