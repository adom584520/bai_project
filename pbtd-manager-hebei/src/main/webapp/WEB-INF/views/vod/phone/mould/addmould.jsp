       ...
       <div style="width:100%;height:100%;">
         	<form id="formQuery" class="layui-form" method="post"> 
			  ...
			  <div class="layui-form-item">
			      ...
			      <div class="layui-input-block " id="moduledianjishijian">
					  <select name="masterplateId" id="masterplateId" lay-verify="validSelected">
						  <option value="0">[请选择模板 提交后无法更改]</option>
			  ...
			  <div class="layui-form-item">
			      <label class="layui-form-label">标题文字图片：</label>
			      <div class="layui-input-block">	
			 ...
			 <div class="layui-form-item">
			  ...
			  <div class="layui-form-item alldivclass directionclass">
			    ...
			    <div class="layui-form-item alldivclass  linktypeclass">
			  ...
			  <div class="layui-form-item alldivclass  channelclass">
			 ...
			 <div class="layui-form-item alldivclass  labelclass">
			  ...
			  <div class="layui-form-item alldivclass linkdiv modulelinktype ">
			   ...
			   <div class="layui-form-item alldivclass linkdiv modulechannelclass">
			   ...
			   <div class="layui-form-item alldivclass linkdiv modulespecialclass">
			  ...
			  <div class="layui-form-item alldivclass linkdiv moduleurlclass">
			  ...
			  <div class="layui-form-item alldivclass linkdiv viewpointstatusclass">
			      <label class="layui-form-label">模版看点是否显示：</label>
			  ...
			  <div class="layui-form-item alldivclass linkdiv moduleviewpointclass">
			    <label class="layui-form-label">请输入模块看点：</label>
			    <div class="layui-input-block">
    	...
    	$('.alldivclass').hide();
    	//选择模块点击事件
        $("#moduledianjishijian").click(function(){
        	$(this).find('dd').click(function(){
        		if($(this).attr("lay-value") == 106 || $(this).attr("lay-value") == 107 || $(this).attr("lay-value") == 108){
        			 $('.alldivclass').hide();
        			 $('.modulelinktype').show();
        		}else{
        			 $('.alldivclass').hide();
