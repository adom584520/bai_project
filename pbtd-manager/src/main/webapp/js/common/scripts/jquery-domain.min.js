...
(function($) {
    ...
    function remove(target, options) {
    	...
    	var title = opts.subject || opts.title;
    ...
    function datagrid(target, options) {
        ...
        var title = opts.subject || opts.title;
        var isHeaderMenu = opts.isHeaderMenu;
    ...
    function changeButtonState(target) {
    	...
    	for(var i=0;i<length;i++){
    		...
    		if(data.status!=null&&data.status!="undefined"&&options.audit=="audit"){
